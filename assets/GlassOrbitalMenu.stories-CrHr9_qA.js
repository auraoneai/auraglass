import{r as n,j as e,m as p,e as X}from"./iframe-CToTmdO0.js";import{f as le}from"./index-CLSxArU-.js";import{u as we}from"./useMotionPreference-BhLipaJT.js";import{u as Ne}from"./a11y-E_E8Udq3.js";import{u as Re}from"./soundDesign-Dn36MD7A.js";import{u as Ve}from"./use-motion-value-D0adgFL2.js";import{u as ke}from"./use-transform-sLPF0mlH.js";import{O as qe}from"./OptimizedGlassCore-tBAFSalT.js";import{P as me}from"./play-nFQrqJOQ.js";import{H as Y}from"./house-ClfRFucI.js";import{U as Z}from"./user-BOGLIbaV.js";import{S as ee}from"./settings-DyQ5HQ7g.js";import{M as se}from"./mail-DJjLJ0SU.js";import{S as ce}from"./search-rWvHghWZ.js";import{B as ue}from"./bell-_TRt8mWr.js";import{H as Ae}from"./heart-BDpiU3ku.js";import{S as Fe}from"./share-DxW71Zo9.js";import{D as Pe}from"./download-CbLtaOga.js";import{c as He}from"./createLucideIcon-CUGeHkPK.js";import{T as Le}from"./trash-2-C-trZeiC.js";import{P as de}from"./plus-DTWID6zg.js";import{P as Te}from"./pause-COWM6dMi.js";import{C as Ge}from"./camera-Ho7mqD0b.js";import{M as _e}from"./mic-CFTiCUIG.js";import{M as De}from"./minus-BXUwSwDa.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";import"./deviceCapabilities-BEZRvwEn.js";const Ue=[["path",{d:"M12 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7",key:"1m0v6g"}],["path",{d:"M18.375 2.625a1 1 0 0 1 3 3l-9.013 9.014a2 2 0 0 1-.853.505l-2.873.84a.5.5 0 0 1-.62-.62l.84-2.873a2 2 0 0 1 .506-.852z",key:"ohrbg2"}]],$e=He("square-pen",Ue),$=n.forwardRef(({items:i=[],centerElement:g,radius:o=120,itemSize:l=48,isOpen:r=!1,onOpenChange:te,rotationSpeed:re=.5,autoRotate:ne=!1,hoverExpansion:ge=1.2,springTension:f=300,springFriction:h=25,glassConfig:fe={},soundEnabled:m=!0,className:he="",style:xe={},...be},Se)=>{const[ye,ie]=n.useState(null),[ve,ze]=n.useState(null),[b,je]=n.useState(0),Oe=n.useRef(null),S=n.useRef(),{prefersReducedMotion:x}=we(),B=Ne(),{play:c}=Re(),J=Ve(0);ke(J,[0,360],[0,360]),n.useEffect(()=>{if(ne&&r&&!x){const s=()=>{je(u=>(u+re)%360),J.set(b),S.current=requestAnimationFrame(s)};S.current=requestAnimationFrame(s)}return()=>{S.current&&cancelAnimationFrame(S.current)}},[ne,r,re,x,b,J]);const Ie=n.useCallback(()=>{te?.(!r),m&&c(r?"close":"open")},[r,te,m,c]),Ce=n.useCallback(s=>{s.disabled||(ie(s.id),s.onClick?.(),m&&c("click"),setTimeout(()=>ie(null),200))},[m,c]),oe=n.useCallback(s=>{ze(s),m&&s&&c("hover")},[m,c]),K=n.useCallback((s,u)=>{const d=(360/u*s+b)*(Math.PI/180),Q=Math.cos(d)*o,W=Math.sin(d)*o;return{x:Q,y:W,angle:d*(180/Math.PI)}},[o,b]),Ee=()=>({hidden:{scale:0,opacity:0,x:0,y:0},visible:s=>({scale:1,opacity:1,x:K(s,i.length).x,y:K(s,i.length).y,transition:{type:"spring",tension:f,friction:h,delay:x?0:s*.1}}),hover:{scale:ge,transition:{type:"spring",tension:f*2,friction:h}},active:{scale:.9,transition:{type:"spring",tension:f*3,friction:h}}}),Me={closed:{rotate:0,scale:1},open:{rotate:x?0:180,scale:1.1,transition:{type:"spring",tension:f,friction:h}}};return e.jsxs(qe,{ref:Se,className:`glass-orbital-menu relative ${he}`,style:{width:(o+l)*2+40,height:(o+l)*2+40,...xe},glassConfig:{blur:20,opacity:.8,saturation:1.2,brightness:1.1,...fe},"aria-label":"Orbital navigation menu",role:"toolbar",id:B,...be,children:[e.jsxs("div",{ref:Oe,className:"glass-absolute glass-inset-0 glass-flex glass-items-center glass-justify-center",children:[e.jsx(p.button,{className:"glass-relative glass-z-20 glass-flex glass-items-center glass-justify-center glass-surface glass-radius-full glass-border glass-border-white/20 glass-backdrop-blur-md glass-surface-subtle/10 hover:glass-surface-subtle/15 glass-transition-colors glass-contrast-guard",style:{width:l+8,height:l+8},variants:Me,animate:r?"open":"closed",onClick:Ie,"aria-expanded":r,"aria-controls":`${B}-items`,"aria-label":r?"Close menu":"Open menu",children:g||e.jsxs(p.div,{className:"glass-w-6 glass-h-6 glass-flex glass-flex-col glass-items-center glass-justify-center",animate:{rotate:r?45:0},children:[e.jsx("div",{className:"glass-w-4 glass-h-0-5 glass-surface-subtle/70 glass-mb-1"}),e.jsx("div",{className:"glass-w-4 glass-h-0-5 glass-surface-subtle/70"})]})}),e.jsx("div",{id:`${B}-items`,className:"glass-absolute glass-inset-0 glass-flex glass-items-center glass-justify-center glass-pointer-events-none",role:"group",children:e.jsx(X,{children:r&&i.map((s,u)=>{const d=K(u,i.length),Q=ve===s.id,W=ye===s.id;return e.jsx(p.div,{className:"glass-absolute glass-pointer-events-auto",custom:u,variants:Ee(),initial:"hidden",animate:"visible",exit:"hidden",whileHover:s.disabled?void 0:"hover",style:{x:d.x,y:d.y},children:e.jsxs(p.button,{className:`
...
}`,...U.parameters?.docs?.source}}};const js=["Default","Closed","AutoRotating","FastRotation","LargeRadius","SmallRadius","ManyItems","MediaControls","CustomCenter","LargeItems","SmallItems","HighExpansion","LowExpansion","SlowAnimation","FastAnimation","BouncyAnimation","StiffAnimation","DisabledItems","NoSounds","CustomGlass","MinimalGlass","IntenseGlass","CompactLayout","SpacedLayout","Interactive"];export{z as AutoRotating,A as BouncyAnimation,v as Closed,_ as CompactLayout,M as CustomCenter,L as CustomGlass,y as Default,P as DisabledItems,q as FastAnimation,j as FastRotation,R as HighExpansion,G as IntenseGlass,U as Interactive,w as LargeItems,O as LargeRadius,V as LowExpansion,C as ManyItems,E as MediaControls,T as MinimalGlass,H as NoSounds,k as SlowAnimation,N as SmallItems,I as SmallRadius,D as SpacedLayout,F as StiffAnimation,js as __namedExportsOrder,zs as default};
