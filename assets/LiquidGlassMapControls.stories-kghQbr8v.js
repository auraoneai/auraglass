import{r as p,j as a,c}from"./iframe-6PHIdj5K.js";import{L as m}from"./LiquidGlassControlGroup-D0FdTZxS.js";import"./preload-helper-PPVm8Dsz.js";import"./LiquidGlassMaterial-2G5x3DpB.js";import"./LiquidGlassLayerProvider-BbZqwf9k.js";const n=p.forwardRef(({controls:i,placement:t="top-right",materialVariant:o="clear",className:l,...s},d)=>a.jsx("div",{ref:d,className:c("liquid-glass-map-controls glass-absolute glass-z-30",l),"data-liquid-glass-map-controls":"true","data-placement":t,...s,children:a.jsx(m,{orientation:"vertical",materialVariant:o,"aria-label":"Map controls",children:i.map(e=>a.jsx("button",{type:"button",disabled:e.disabled,"aria-label":e.label,className:"glass-radius-full glass-p-2",onClick:e.onClick,children:e.icon??e.label},e.id))})}));n.displayName="LiquidGlassMapControls";try{n.displayName="LiquidGlassMapControls",n.__docgenInfo={description:"",displayName:"LiquidGlassMapControls",props:{controls:{defaultValue:null,description:"",name:"controls",required:!0,type:{name:"LiquidGlassMapControl[]"}},placement:{defaultValue:{value:"top-right"},description:"",name:"placement",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"top-right"'},{value:'"top-left"'},{value:'"bottom-right"'},{value:'"bottom-left"'}]}},materialVariant:{defaultValue:{value:"clear"},description:"",name:"materialVariant",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"clear"'},{value:'"regular"'}]}}}}}catch{}const f={title:"Effects + Advanced/Liquid Glass Map Controls",component:n,parameters:{layout:"fullscreen",previewSurface:"app"}},r={render:()=>a.jsxs("div",{style:{minHeight:"100vh",width:"100%",display:"grid",placeItems:"center",padding:32,boxSizing:"border-box"},children:[a.jsx("style",{children:`
        .liquid-map-story {
          position: relative;
          width: min(980px, 100%);
          min-height: 560px;
