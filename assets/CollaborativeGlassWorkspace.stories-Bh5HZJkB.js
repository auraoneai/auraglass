import{j as s,r as i,c as b,g as h}from"./iframe-C4NFeGrN.js";import{c as R}from"./createLucideIcon-Dya9Njuo.js";import{M as ts}from"./mic-Bnn6DbBX.js";import{M as vs}from"./mic-off-BdQgniG8.js";import{L as ws}from"./layers-CrDP1YmZ.js";import{M as ys,a as os}from"./minimize-DUtSNlu7.js";import{C as ks}from"./copy-BVnFMqDM.js";import{T as js}from"./trash-2-BgkqXIJV.js";import{S as Ns}from"./save-BT4RBCBS.js";import{S as Cs}from"./settings-Da3XZcex.js";import"./preload-helper-PPVm8Dsz.js";const Ss=[["path",{d:"M11 14h10",key:"1w8e9d"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v1.344",key:"1e62lh"}],["path",{d:"m17 18 4-4-4-4",key:"z2g111"}],["path",{d:"M8 4H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 1.793-1.113",key:"bjbb7m"}],["rect",{x:"8",y:"2",width:"8",height:"4",rx:"1",key:"ublpy"}]],Vs=R("clipboard-paste",Ss);const Es=[["path",{d:"M21 7v6h-6",key:"3ptur4"}],["path",{d:"M3 17a9 9 0 0 1 9-9 9 9 0 0 1 6 2.3l3 2.7",key:"1kgawr"}]],ns=R("redo",Es);const Ms=[["path",{d:"M3 7v6h6",key:"1v2h90"}],["path",{d:"M21 17a9 9 0 0 0-9-9 9 9 0 0 0-6 2.3L3 13",key:"1r6uu6"}]],is=R("undo",Ms);const qs=[["path",{d:"M12 20h.01",key:"zekei9"}],["path",{d:"M2 8.82a15 15 0 0 1 20 0",key:"dnpr2z"}],["path",{d:"M5 12.859a10 10 0 0 1 14 0",key:"1x1e6c"}],["path",{d:"M8.5 16.429a5 5 0 0 1 7 0",key:"1bycff"}]],Is=R("wifi",qs);function O(e){return s.jsx(A,{"data-glass-component":!0,workspaceId:e.workspaceId,userId:e.userId,userName:e.userName,userEmail:e.userEmail,userRole:e.userRole,userAvatar:e.userAvatar,autoConnect:!0,enableVoice:e.enableVoiceChat,enableCursorTracking:e.showCursors,enableComments:e.enableComments,showDebugInfo:!1,children:s.jsx(Us,{...e})})}function Us({className:e="",layout:o="split",theme:a="dark",showMiniMap:r=!0,showOnlineUsers:l=!0,showCursors:t=!0,enableAdvancedEffects:c=!0,canvasWidth:n=1200,canvasHeight:u=800,gridSize:g=20,showGrid:x=!0,showRulers:v=!1,enableSnapping:w=!0,enableVoiceChat:p=!1,enableScreenSharing:H=!1,enableComments:y=!0,enableVersionControl:m=!0,enableRealTimeSync:N=!0,onWorkspaceReady:C,onUserJoined:J,onUserLeft:T,onElementSelected:k,onError:d,"aria-label":gs}){const ds={workspace:{id:"workspace-1",name:"Collaborative Design Session"},currentUser:{id:"user-1",name:"Current User",role:"admin"},onlineUsers:[{id:"user-1",name:"Alice Johnson",role:"admin",avatar:"",color:"var(--glass-color-primary)"},{id:"user-2",name:"Bob Smith",role:"editor",avatar:"",color:"var(--glass-color-success)"},{id:"user-3",name:"Carol Davis",role:"viewer",avatar:"",color:"var(--glass-color-warning)"}],canEdit:!0,isVoiceActive:!1,voiceUsers:[],toggleVoice:()=>{},createSnapshot:()=>{},undo:()=>{},redo:()=>{},canUndo:!0,canRedo:!1},{workspace:j,currentUser:W,onlineUsers:B,canEdit:us,isVoiceActive:S,voiceUsers:z,toggleVoice:L,createSnapshot:Q,undo:K,redo:X,canUndo:Y,canRedo:Z}=ds,[V,ps]=i.useState(o),[P,ms]=i.useState(null),[ss,bs]=i.useState(!0),[hs,Os]=i.useState(!0),[G,es]=i.useState(!1),[fs,as]=i.useState(!1),[xs,ls]=i.useState(!1);i.useEffect(()=>{j&&C?.(j)},[j,C]);const E=i.useCallback(rs=>{ms(rs),k?.(rs)},[k]),f=i.useMemo(()=>{switch(V){case"canvas-focused":return{canvasSize:"flex-1",editorSize:"w-80",direction:"row",canvasFirst:!0};case"editor-focused":return{canvasSize:"w-80",editorSize:"flex-1",direction:"row",canvasFirst:!1};case"tabs":return{canvasSize:"w-full",editorSize:"w-full",direction:"col",canvasFirst:!0};default:return{canvasSize:"flex-1",editorSize:"flex-1",direction:"row",canvasFirst:!0}}},[V]);return!j||!W?s.jsx(Ps,{message:"Setting up workspace..."}):s.jsxs("div",{className:b("glass-collaborative-workspace workspace-glass-shell glass-h-screen glass-flex glass-flex-col glass-surface-dark",e),role:"main","aria-live":"polite","aria-label":gs,children:[s.jsx("style",{children:`
...
}`,..._.parameters?.docs?.source}}};const se=["Default","DesignStudio","CodeCollaboration","MinimalWorkspace","VoiceEnabled"];export{I as CodeCollaboration,M as Default,q as DesignStudio,U as MinimalWorkspace,_ as VoiceEnabled,se as __namedExportsOrder,Zs as default};
