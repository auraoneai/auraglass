import{j as e,r as n,c as l,d as j}from"./iframe-CYOgkXcw.js";import{D,u as k}from"./GlassDragDropProvider-BYXzBNW_.js";import{G as _}from"./GlassComponentPalette-DnlFVjBU.js";import{G as T}from"./GlassCanvas-D6xuFVIy.js";import{G as E}from"./GlassPropertyPanel-XsXjnh7Z.js";import{G as A}from"./GlassPageStructure-BNtE2NyH.js";import"./preload-helper-PPVm8Dsz.js";import"./GlassCore-DVXuycve.js";import"./colorInput-DwY-dk75.js";const I=[{key:"desktop",icon:"🖥️",label:"Desktop"},{key:"tablet",icon:"📱",label:"Tablet"},{key:"mobile",icon:"📱",label:"Mobile"}],L=()=>{const{pageState:a,undo:o,redo:g,canUndo:p,canRedo:i,togglePreviewMode:t,setActiveBreakpoint:r,toggleGrid:d,toggleSnapToGrid:x,clearPage:b,exportPage:h,importPage:m}=k(),u=n.useCallback(()=>{const s=h();localStorage.setItem("glass-page-builder-autosave",JSON.stringify(s))},[h]),c=n.useCallback(()=>{const s=localStorage.getItem("glass-page-builder-autosave");if(s)try{const P=JSON.parse(s);m(P)}catch{}},[m]);return n.useEffect(()=>{const s=setInterval(()=>{a.components.length>0&&u()},j.DURATION.slower*42);return()=>clearInterval(s)},[a.components.length,u]),e.jsxs("div",{"data-glass-component":!0,className:"glass-flex glass-items-center glass-justify-between glass-p-4 glass-surface-subtle glass-border-b glass-border-subtle",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[e.jsx("h1",{className:"glass-text-xl glass-font-bold glass-text-secondary",children:"Page Builder"}),e.jsx("span",{className:"glass-text-xs glass-text-secondary glass-surface-subtle glass-px-2 glass-py-1 glass-radius",children:"v1.0"})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[e.jsxs("button",{onClick:b,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"🗑️"}),"New"]}),e.jsxs("button",{onClick:u,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"💾"}),"Save"]}),e.jsxs("button",{onClick:c,className:"glass-flex glass-items-center glass-gap-2 glass-px-3 glass-py-2 glass-text-sm glass-text-secondary hover:glass-surface-subtle glass-radius-md glass-transition-colors glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard",children:[e.jsx("span",{children:"📁"}),"Load"]})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1",children:[e.jsx("button",{onClick:o,disabled:!p(),className:l("p-2 rounded-md transition-colors",p()?"glass-text-secondary hover:bg-white/10 hover:glass-text-primary":"glass-text-disabled cursor-not-allowed"),title:"Undo (Ctrl+Z)",children:"↶"}),e.jsx("button",{onClick:g,disabled:!i(),className:l("p-2 rounded-md transition-colors",i()?"glass-text-secondary hover:bg-white/10 hover:glass-text-primary":"glass-text-disabled cursor-not-allowed"),title:"Redo (Ctrl+Y)",children:"↷"})]})]}),e.jsx("div",{className:"glass-flex glass-items-center glass-gap-2 glass-surface-subtle glass-radius-lg glass-p-1",children:I.map(s=>e.jsxs("button",{onClick:()=>r(s.key),className:l("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",a.activeBreakpoint===s.key?"bg-white/15 glass-text-primary shadow-sm":"glass-text-secondary hover:glass-text-primary"),title:s.label,children:[e.jsx("span",{children:s.icon}),s.label]},s.key))}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[e.jsxs("button",{onClick:d,className:l("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",a.showGrid?"bg-blue-500/20 text-blue-200":"glass-text-secondary hover:bg-white/10"),children:[e.jsx("span",{children:"⊞"}),"Grid"]}),e.jsxs("button",{onClick:x,className:l("flex items-center gap-2 px-3 py-2 text-sm rounded-md transition-colors",a.snapToGrid?"bg-blue-500/20 text-blue-200":"glass-text-secondary hover:bg-white/10"),children:[e.jsx("span",{children:"🧲"}),"Snap"]})]}),e.jsx("div",{className:"glass-w-px glass-h-6 glass-surface-subtle"}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[e.jsxs("button",{onClick:t,className:l("flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-md transition-colors",a.previewMode?"bg-green-600 text-white hover:bg-green-700":"bg-white/10 glass-text-secondary hover:bg-white/15"),children:[e.jsx("span",{children:a.previewMode?"👁️":"✏️"}),a.previewMode?"Exit Preview":"Preview"]}),e.jsxs("button",{onClick:()=>{h(),alert("Page published! (Demo)")},className:"glass-flex glass-items-center glass-gap-2 glass-px-4 glass-py-2 glass-text-sm glass-font-medium glass-surface-blue glass-text-primary hover:glass-surface-blue glass-radius-md glass-transition-colors",children:[e.jsx("span",{children:"🚀"}),"Publish"]})]})]})]})},R=({className:a,initialData:o,onSave:g,onPreview:p,onPublish:i,"data-testid":t})=>{const{importPage:r}=k(),[d,x]=n.useState(!1),[b,h]=n.useState(!1),[m,u]=n.useState("components");return n.useEffect(()=>{if(o)r(o);else{const c=localStorage.getItem("glass-page-builder-autosave");if(c)try{const s=JSON.parse(c);r(s)}catch{}}},[o,r]),n.useEffect(()=>{const c=s=>{if((s.metaKey||s.ctrlKey)&&!s.shiftKey&&!s.altKey)switch(s.key){case"z":s.preventDefault();break;case"y":s.preventDefault();break;case"s":s.preventDefault();break;case"p":s.preventDefault();break}};return document.addEventListener("keydown",c),()=>document.removeEventListener("keydown",c)},[g,p]),e.jsxs("div",{className:l("h-screen flex flex-col overflow-auto glass-surface-subtle",a),"data-testid":t,children:[e.jsx(L,{}),e.jsxs("div",{className:"glass-flex-1 glass-flex glass-overflow-auto",children:[e.jsxs("div",{className:"glass-flex",children:[!d&&e.jsxs("div",{className:"glass-w-12 glass-surface-subtle glass-border-r glass-border-subtle glass-flex glass-flex-col",children:[e.jsxs("button",{onClick:()=>u("components"),className:l("flex flex-col items-center gap-1 p-3 text-xs transition-colors",m==="components"?"bg-blue-500/20 text-blue-200":"glass-text-secondary hover:bg-white/10"),title:"Components",children:[e.jsx("span",{className:"glass-text-lg",children:"📦"}),"Comp"]}),e.jsxs("button",{onClick:()=>u("structure"),className:l("flex flex-col items-center gap-1 p-3 text-xs transition-colors",m==="structure"?"bg-blue-500/20 text-blue-200":"glass-text-secondary hover:bg-white/10"),title:"Structure",children:[e.jsx("span",{className:"glass-text-lg",children:"🌳"}),"Tree"]})]}),e.jsx("div",{className:"glass-border-r glass-border-subtle",children:m==="components"?e.jsx(_,{collapsed:d,onToggleCollapse:()=>x(!d)}):e.jsx(A,{collapsed:d,onToggleCollapse:()=>x(!d)})})]}),e.jsx(T,{}),e.jsx("div",{className:"glass-border-l glass-border-subtle",children:e.jsx(E,{collapsed:b,onToggleCollapse:()=>h(!b)})})]}),e.jsxs("div",{className:"glass-h-6 glass-surface-primary glass-text-secondary glass-text-xs glass-flex glass-items-center glass-justify-between glass-px-4",children:[e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsx("span",{children:"🟢 Ready"}),e.jsx("span",{children:"Auto-save: ON"})]}),e.jsxs("div",{className:"glass-flex glass-items-center glass-gap-4",children:[e.jsx("span",{children:"Zoom: 100%"}),e.jsxs("span",{children:["Grid: ","OFF"]})]})]})]})},S=a=>e.jsx(D,{children:e.jsx(R,{...a})});try{S.displayName="GlassPageBuilder",S.__docgenInfo={description:"",displayName:"GlassPageBuilder",props:{className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string | undefined"}},initialData:{defaultValue:null,description:"",name:"initialData",required:!1,type:{name:"PageBuilderInitialData | undefined"}},onSave:{defaultValue:null,description:"",name:"onSave",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},onPreview:{defaultValue:null,description:"",name:"onPreview",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},onPublish:{defaultValue:null,description:"",name:"onPublish",required:!1,type:{name:"((data: PageExportData) => void) | undefined"}},"data-testid":{defaultValue:null,description:"",name:"data-testid",required:!1,type:{name:"string | undefined"}}}}}catch{}const q={title:"Workflows/Glass Page Builder",component:S,decorators:[a=>e.jsxs("div",{className:"ag-page-builder-story",children:[e.jsx("style",{children:`
