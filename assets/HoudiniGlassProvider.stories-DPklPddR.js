import{j as s}from"./iframe-DpweptvF.js";import{H as r,a,b as c}from"./HoudiniGlassCard-DmvptgXO.js";import"./preload-helper-PPVm8Dsz.js";import"./settings-CGluIMgx.js";import"./createLucideIcon-eJ4-KqhR.js";import"./eye-CLpoDiLK.js";import"./zap-CABfnkw_.js";import"./droplets-DLwV55Sc.js";import"./layers-DelfAAVy.js";import"./sun-Bc3Sa5NP.js";import"./sparkles-K0K_G9Et.js";const y={title:"Houdini/HoudiniGlassProvider",component:r,parameters:{layout:"fullscreen",docs:{description:{component:"Native CSS Houdini integration for browser-accelerated glass effects with Paint Worklets and Properties API."}}},argTypes:{defaultPreset:{control:{type:"select",options:["standard","frosted","minimal","heavy","crystal"]},description:"Initial glass preset"},performanceMode:{control:"boolean",description:"Enable performance optimizations"},debugMode:{control:"boolean",description:"Enable debug interface"}}},l={args:{defaultPreset:"standard",enabledEffects:["frost","caustics","border"],performanceMode:!1,debugMode:!0},render:e=>s.jsx(r,{...e,children:s.jsx(c,{})})},t={args:{defaultPreset:"frosted",enabledEffects:["frost","caustics"],performanceMode:!1,debugMode:!1},render:e=>s.jsx(r,{...e,children:s.jsx("div",{className:"glass-min-glass-h-screen glass-gradient-primary glass-gradient-primary via-purple-900 glass-gradient-primary glass-p-8",children:s.jsxs("div",{className:"max-w-6xl glass-mx-auto",children:[s.jsx("h1",{className:"glass-text-4xl glass-font-bold glass-text-primary glass-text-center mb-12",children:"Houdini Glass Card Gallery"}),s.jsxs("div",{className:"glass-grid glass-glass-grid-cols-1 md:glass-glass-grid-cols-2 lg:glass-glass-grid-cols-3 glass-gap-6",children:[s.jsx(a,{title:"Standard Glass",description:"Clean, balanced glass effect",preset:"standard",effects:["frost"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"✨"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Standard glass with subtle frost effect and smooth interactions."})]})}),s.jsx(a,{title:"Frosted Glass",description:"Enhanced frost with caustics",preset:"frosted",effects:["frost","caustics"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"❄️"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Frosted glass with dynamic caustics and enhanced blur."})]})}),s.jsx(a,{title:"Crystal Clear",description:"Ultra-clear minimal glass",preset:"crystal",effects:["border"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"💎"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Crystal clear glass with minimal blur and elegant borders."})]})}),s.jsx(a,{title:"Heavy Glass",description:"Maximum glass intensity",preset:"heavy",effects:["frost","caustics","border"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"🔮"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Heavy glass with maximum blur, multiple effects, and rich depth."})]})}),s.jsx(a,{title:"Minimal Glass",description:"Subtle, clean appearance",preset:"minimal",effects:["frost"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"🌟"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Minimal glass with subtle effects and clean aesthetics."})]})}),s.jsx(a,{title:"Performance Mode",description:"Optimized for performance",preset:"standard",effects:["frost"],showControls:!0,interactive:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"⚡"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Performance-optimized glass with reduced effects for smooth rendering."})]})})]})]})})})},i={args:{defaultPreset:"minimal",enabledEffects:["frost"],performanceMode:!0,debugMode:!0},render:e=>s.jsx(r,{...e,children:s.jsx("div",{className:"glass-min-glass-h-screen glass-gradient-primary glass-gradient-primary via-blue-900 glass-gradient-primary glass-p-8",children:s.jsxs("div",{className:"max-w-4xl glass-mx-auto",children:[s.jsx("h1",{className:"glass-text-3xl glass-font-bold glass-text-primary glass-text-center mb-8",children:"Performance Optimized Glass"}),s.jsxs("div",{className:"glass-grid glass-glass-grid-cols-1 md:glass-glass-grid-cols-2 glass-gap-6",children:[s.jsx(a,{title:"Optimized Card",description:"Performance-optimized effects",preset:"minimal",effects:["frost"],showControls:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("h3",{className:"glass-text-lg glass-font-semibold glass-text-primary glass-mb-2",children:"🚀 Fast Rendering"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm glass-mb-4",children:"Reduced effects for maximum performance while maintaining visual appeal."}),s.jsx("div",{className:"glass-text-xs glass-text-primary glass-surface-green/10 glass-px-2 glass-py-1 glass-radius",children:"Performance Mode Active"})]})}),s.jsx(a,{title:"Debug Info",description:"Performance monitoring",preset:"minimal",effects:["border"],showControls:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("h3",{className:"glass-text-lg glass-font-semibold glass-text-primary glass-mb-2",children:"📊 Performance Stats"}),s.jsxs("div",{className:"glass-space-y-2 glass-text-sm",children:[s.jsxs("div",{className:"glass-flex glass-justify-between",children:[s.jsx("span",{className:"glass-text-primary/60",children:"FPS:"}),s.jsx("span",{className:"glass-text-primary",children:"60"})]}),s.jsxs("div",{className:"glass-flex glass-justify-between",children:[s.jsx("span",{className:"glass-text-primary/60",children:"Memory:"}),s.jsx("span",{className:"glass-text-primary",children:"Low"})]}),s.jsxs("div",{className:"glass-flex glass-justify-between",children:[s.jsx("span",{className:"glass-text-primary/60",children:"Effects:"}),s.jsx("span",{className:"glass-text-primary",children:"Optimized"})]})]})]})})]})]})})})},d={args:{defaultPreset:"standard",enabledEffects:["frost","caustics"],performanceMode:!1,debugMode:!0,defaultProperties:{"--glass-background":"rgba(255, 20, 147, 0.1)","--glass-border":"rgba(255, 20, 147, 0.3)","--glass-blur":"25px"}},render:e=>s.jsx(r,{...e,children:s.jsx("div",{className:"glass-min-glass-h-screen glass-gradient-primary glass-gradient-primary via-purple-900 glass-gradient-primary glass-p-8",children:s.jsxs("div",{className:"max-w-4xl glass-mx-auto",children:[s.jsx("h1",{className:"glass-text-3xl glass-font-bold glass-text-primary glass-text-center mb-8",children:"Custom Glass Properties"}),s.jsxs("div",{className:"glass-grid glass-glass-grid-cols-1 md:glass-glass-grid-cols-2 glass-gap-6",children:[s.jsx(a,{title:"Custom Colors",description:"Deep pink glass theme",preset:"standard",effects:["frost","caustics"],showControls:!0,customProperties:{"--glass-background":"rgba(255, 20, 147, 0.15)","--glass-border":"rgba(255, 20, 147, 0.4)","--glass-blur":"30px"},children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("div",{className:"glass-text-4xl glass-mb-4",children:"🌸"}),s.jsx("h3",{className:"glass-text-lg glass-font-semibold glass-text-primary glass-mb-2",children:"Custom Theme"}),s.jsx("p",{className:"glass-text-primary/80 glass-text-sm",children:"Custom CSS properties allow for completely personalized glass effects."})]})}),s.jsx(a,{title:"Property Inspector",description:"View custom properties",preset:"standard",effects:["border"],showControls:!0,children:s.jsxs("div",{className:"glass-p-4",children:[s.jsx("h3",{className:"glass-text-lg glass-font-semibold glass-text-primary glass-mb-2",children:"🎨 Active Properties"}),s.jsxs("div",{className:"space-y-1 glass-text-xs glass-text-primary/70",children:[s.jsx("div",{children:"--glass-background: rgba(255, 20, 147, 0.1)"}),s.jsx("div",{children:"--glass-border: rgba(255, 20, 147, 0.3)"}),s.jsx("div",{children:"--glass-blur: 25px"}),s.jsx("div",{children:"--glass-animation-speed: 1"})]})]})})]})]})})})};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...d.parameters?.docs?.source}}};const N=["Showcase","CardGallery","PerformanceMode","CustomProperties"];export{t as CardGallery,d as CustomProperties,i as PerformanceMode,l as Showcase,N as __namedExportsOrder,y as default};
