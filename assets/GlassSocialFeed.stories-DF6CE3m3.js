import{r as l,b as ye,d as c,j as s,e as Te,m as g}from"./iframe-DyzGTO6j.js";import{u as O}from"./a11y-D_lkiUOl.js";import{u as be}from"./useMotionPreference-BStju7rk.js";import{c as V}from"./createGlassStyle-BfWnO-qv.js";import{O as Ce}from"./OptimizedGlassCore-Dz0CoTUd.js";import"./preload-helper-PPVm8Dsz.js";import"./deviceCapabilities-Cly_GjbT.js";const W={low:{color:"var(--glass-gray-500)",icon:"📊"},medium:{color:"var(--glass-color-success)",icon:"📈"},high:{color:"var(--glass-color-warning)",icon:"🔥"},viral:{color:"var(--glass-color-danger)",icon:"🚀"}},$=l.forwardRef(({posts:o,currentUserId:Ie,showInteractions:_=!0,showTimestamps:z=!0,showMedia:J=!0,showTags:Y=!0,compactMode:d=!1,maxHeight:U,infiniteScroll:K=!1,realTimeUpdates:H=!1,sortBy:P="timestamp",filterBy:D="all",onLike:Q,onShare:X,onComment:Z,onUserClick:ee,onPostClick:se,onLoadMore:q,className:te="",...ae},re)=>{const ne=ye(),[B,oe]=l.useState(new Set),[ie,le]=l.useState(new Set),[ce,de]=l.useState(new Set),[A,me]=l.useState(o);O("glass-social-feed");const L=O("glass-social-sort"),{shouldAnimate:ue}=be(),ge=e=>ue?e:{duration:0};l.useEffect(()=>{if(!H)return;const e=setInterval(()=>{me(a=>a.map(t=>({...t,likes:t.likes+(Math.random()<.3?Math.floor(Math.random()*3):0),comments:t.comments+(Math.random()<.2?1:0),shares:t.shares+(Math.random()<.15?1:0)})))},c.DURATION.slower*7);return()=>clearInterval(e)},[H]);const G=l.useMemo(()=>{let e=[...A];switch(D){case"following":e=e.filter(a=>a.author.verified);break;case"liked":e=e.filter(a=>B.has(a.id));break}switch(P){case"likes":e.sort((a,t)=>t.likes-a.likes);break;case"engagement":e.sort((a,t)=>t.likes+t.comments+t.shares-(a.likes+a.comments+a.shares));break;default:e.sort((a,t)=>t.timestamp.getTime()-a.timestamp.getTime())}return e},[A,D,P,B]),he=e=>{const t=new Date().getTime()-e.getTime(),i=Math.floor(t/6e4),u=Math.floor(t/36e5),m=Math.floor(t/864e5);return i<1?"Just now":i<60?`${i}m`:u<24?`${u}h`:m<7?`${m}d`:e.toLocaleDateString()},fe=e=>{const a=e.likes+e.comments+e.shares;return a>1e3?"viral":a>100?"high":a>10?"medium":"low"},pe=e=>{oe(a=>{const t=new Set(a);return t.has(e)?t.delete(e):t.add(e),t}),Q?.(e)},we=e=>{le(a=>new Set(a).add(e)),X?.(e)},xe=e=>{de(a=>{const t=new Set(a);return t.has(e)?t.delete(e):t.add(e),t})},ve=({post:e,index:a})=>{const t=ce.has(e.id),i=B.has(e.id),u=ie.has(e.id),m=fe(e),R=!d&&e.content.length>200;return s.jsxs(g.div,{layout:!0,initial:{opacity:0,y:20},animate:ne?{}:{opacity:1,y:0},exit:{opacity:0,y:-20},transition:ge({duration:c.DURATION.normal/1e3,delay:a*.05}),className:`
            relative p-4 rounded-lg cursor-pointer transition-all duration-[${c.DURATION.fast}ms]
            ${V({variant:"default"})}
            hover:bg-white/5 border border-white/10
          `,onClick:()=>se?.(e.id),children:[s.jsxs("div",{className:"glass-flex glass-items-start glass-space-x-3 glass-mb-3",children:[s.jsxs(g.div,{className:"glass-relative glass-cursor-pointer",onClick:r=>{r.stopPropagation(),ee?.(e.author.id)},whileHover:{scale:1.05},whileTap:{scale:.95},children:[s.jsx("div",{className:`
                ${d?"w-8 h-8":"w-12 h-12"}
              ...
              `,children:e.author.avatar?s.jsx("img",{src:e.author.avatar,alt:e.author.name,className:"glass-w-full glass-h-full glass-radius-full glass-object-cover"}):e.author.name.charAt(0).toUpperCase()}),e.author.verified&&s.jsx("div",{className:"glass-absolute glass--glass-bottom-1 glass--right-1 glass-w-4 glass-h-4 glass-surface-blue glass-radius-full glass-flex glass-items-center glass-justify-center",children:s.jsx("span",{className:"glass-text-primary glass-text-xs",children:"✓"})})]}),s.jsxs("div",{className:"glass-flex-1 glass-min-glass-w-0",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-2",children:[s.jsx("h3",{className:`
                ...
                `,children:e.author.name}),s.jsxs("span",{className:`
                  text-white/60
                  ${d?"text-xs":"text-sm"}
                `,children:["@",e.author.username]}),s.jsx("div",{className:"glass-w-2 glass-h-2 glass-radius-full",style:{backgroundColor:W[m].color},title:`${m} engagement`})]}),z&&s.jsx("p",{className:`
                  text-white/50
                  ${d?"text-xs":"text-sm"}
                `,children:he(e.timestamp)})]})]}),s.jsxs("div",{className:"glass-mb-3",children:[s.jsxs("p",{className:`
            ...
            `,children:[R&&!t?`${e.content.slice(0,200)}...`:e.content,R&&s.jsx("button",{onClick:r=>{r.stopPropagation(),xe(e.id)},className:"glass-ml-2 glass-text-primary hover:glass-text-secondary glass-text-sm glass-font-medium glass-focus glass-touch-target glass-contrast-guard",children:t?"Show less":"Show more"})]}),Y&&e.tags&&e.tags.length>0&&s.jsx("div",{className:"glass-flex glass-flex-wrap glass-gap-2 glass-mt-2",children:e.tags.map(r=>s.jsxs("span",{className:`
              ...
              `,children:e.media.slice(0,4).map((r,F)=>s.jsxs("div",{className:"glass-relative glass-aspect-square glass-surface-subtle/5 glass-radius-lg glass-overflow-hidden",children:[r.type==="image"?s.jsx("img",{src:r.url,alt:r.alt||"Post media",className:`glass-w-full glass-h-full glass-object-cover glass-hover-scale-105 glass-transition-transform glass-duration-[${c.DURATION.normal}ms]`}):r.type==="video"?s.jsx("video",{src:r.url,poster:r.thumbnail,className:"glass-w-full glass-h-full glass-object-cover",controls:!0}):s.jsx("img",{src:r.url,alt:r.alt||"GIF",className:"glass-w-full glass-h-full glass-object-cover"}),e.media&&e.media.length>4&&F===3&&s.jsx("div",{className:"glass-absolute glass-inset-0 glass-surface-dark/60 glass-flex glass-items-center glass-justify-center",children:s.jsxs("span",{className:"glass-text-primary glass-font-semibold",children:["+",e.media.length-3," more"]})})]},F))})}),_&&s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between glass-pt-3 glass-border-t glass-border-white/10",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-6",children:[s.jsxs(g.button,{onClick:r=>{r.stopPropagation(),pe(e.id)},className:`
                  ...
                  `,whileHover:{scale:1.05},whileTap:{scale:.95},children:[s.jsx("span",{children:i?"❤️":"🤍"}),s.jsx("span",{children:e.likes+(i?1:0)})]}),s.jsxs("button",{onClick:r=>{r.stopPropagation(),Z?.(e.id)},className:"glass-flex glass-items-center glass-space-x-2 glass-text-sm glass-text-primary-glass-opacity-60 hover:glass-text-primary glass-transition-colors glass-duration-200 glass-focus glass-touch-target glass-contrast-guard",children:[s.jsx("span",{children:"💬"}),s.jsx("span",{children:e.comments})]}),s.jsxs(g.button,{onClick:r=>{r.stopPropagation(),we(e.id)},className:`
                    flex items-center space-x-2 text-sm transition-colors duration-[${c.DURATION.fast}ms]
                    ${u?"text-green-400":"text-white/60 hover:text-green-400"}
                  `,whileHover:{scale:1.05},whileTap:{scale:.95},children:[s.jsx("span",{children:"🔄"}),s.jsx("span",{children:e.shares+(u?1:0)})]})]}),s.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-2 glass-text-sm glass-text-primary-glass-opacity-50",children:[s.jsx("span",{children:W[m].icon}),s.jsx("span",{children:e.likes+e.comments+e.shares})]})]})]})};return s.jsx(Ce,{ref:re,variant:"frosted",className:`${te}`,style:{maxHeight:U,overflowY:U?"auto":void 0,overflowX:"hidden"},...ae,children:s.jsxs("div",{className:"glass-p-4 glass-space-y-4",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between",children:[s.jsxs("h2",{className:"glass-text-lg glass-font-semibold glass-text-primary-glass-opacity-90",children:["Social Feed (",G.length,")"]}),s.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-2 glass-text-sm",children:[H&&s.jsxs("div",{className:"glass-flex glass-items-center glass-space-x-1 glass-text-primary",children:[s.jsx("div",{className:"glass-w-2 glass-h-2 glass-surface-green glass-radius-full glass-animate-pulse"}),s.jsx("span",{children:"Live"})]}),s.jsx("label",{htmlFor:L,className:"glass-sr-only",children:"Sort posts by"}),s.jsxs("select",{id:L,value:P,onChange:e=>{},className:"glass-surface-subtle/10 glass-border glass-border-white/20 glass-radius glass-px-2 glass-py-1 glass-text-primary glass-text-sm glass-focus glass-touch-target glass-contrast-guard","aria-label":"Sort posts by",children:[s.jsx("option",{value:"timestamp",children:"Latest"}),s.jsx("option",{value:"likes",children:"Most Liked"}),s.jsx("option",{value:"engagement",children:"Most Engaging"})]})]})]}),s.jsxs("div",{className:`
              space-y-4 
              ${U?"overflow-y-auto":""}
            `,children:[s.jsx(Te,{children:G.map((e,a)=>s.jsx(ve,{post:e,index:a},e.id))}),K&&q&&s.jsx(g.button,{onClick:q,className:`
...
}`,...S.parameters?.docs?.source}}};const Pe=["Default","CompactMode","RealTimeUpdates","SortByLikes","SortByEngagement","LimitedHeight","NoMedia","NoInteractions","TextOnly","VerifiedUsers","HighEngagement","RecentPosts","WithInfiniteScroll","MinimalView","EmptyFeed","SinglePost","LongContent"];export{f as CompactMode,h as Default,M as EmptyFeed,I as HighEngagement,v as LimitedHeight,S as LongContent,j as MinimalView,T as NoInteractions,y as NoMedia,p as RealTimeUpdates,k as RecentPosts,N as SinglePost,x as SortByEngagement,w as SortByLikes,b as TextOnly,C as VerifiedUsers,E as WithInfiniteScroll,Pe as __namedExportsOrder,He as default};
