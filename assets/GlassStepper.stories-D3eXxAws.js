import{r as c,j as s,c as p,d as v}from"./iframe-CToTmdO0.js";import{f as u}from"./index-CLSxArU-.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";const d=[{id:"step1",label:"Step 1"},{id:"step2",label:"Step 2"},{id:"step3",label:"Step 3"}];function i({steps:r=d,active:a=d[0].id,onChange:g,className:m,...f}){const o=c.useRef(null);return c.useEffect(()=>{o.current=a},[a]),s.jsx("div",{"data-glass-component":!0,className:p("flex items-center glass-gap-3",m),...f,children:r.map((e,b)=>{const t=e.id===a,S=t&&o.current!==a;return s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-3",children:[s.jsx("button",{type:"button","aria-current":t?"step":void 0,"aria-label":`Go to ${e.label}${t?" (current step)":""}`,className:p(`glass-px-3 glass-py-1.5 glass-radius-full glass-text-sm transition-all duration-[${v.DURATION.fast}ms]`,"ring-1 ring-white/10 bg-glass-fill glass-hover--translate-y-0-5 glass-press glass-ripple","glass-focus glass-touch-target glass-contrast-guard",t?"glass-text-primary":"glass-text-primary/80"),onClick:h=>g?.(e.id),children:s.jsx("span",{className:p("relative",S&&"glass-pulse-ring"),children:e.label})}),b<r.length-1&&s.jsx("div",{className:"glass-w-8 glass-h-px glass-surface-subtle/15"})]},e.id)})})}try{i.displayName="GlassStepper",i.__docgenInfo={description:"",displayName:"GlassStepper",props:{steps:{defaultValue:{value:`[
