import{R as y,b as Z,r as g,j as s,d as b,m as x,c as I,e as V}from"./iframe-DyzGTO6j.js";import{f as _}from"./index-CLSxArU-.js";import{c as D}from"./createLucideIcon-BZG7jVWE.js";import{M as ss}from"./move-BMzB7LW2.js";import{V as as}from"./volume-2-BbHoeMZW.js";import{K as es}from"./keyboard-DbtGJE1v.js";import{S as ls}from"./settings-Bqo7IHqq.js";import{M as ts}from"./monitor-xmzbc974.js";import{R as rs}from"./rotate-ccw-DDQjwSj1.js";import{C as is}from"./check-BG3Lvwn4.js";import{I as ns}from"./info-DO85QKpS.js";import{C as os}from"./chevron-up-8Wel7Lu5.js";import{C as gs}from"./chevron-down-B3zZ8_0Q.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";const ds=[["circle",{cx:"16",cy:"4",r:"1",key:"1grugj"}],["path",{d:"m18 19 1-7-6 1",key:"r0i19z"}],["path",{d:"m5 8 3-3 5.5 3-2.36 3.5",key:"9ptxx2"}],["path",{d:"M4.24 14.5a5 5 0 0 0 6.88 6",key:"10kmtu"}],["path",{d:"M13.76 17.5a5 5 0 0 0-6.88-6",key:"2qq6rc"}]],cs=D("accessibility",ds);const us=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 18a6 6 0 0 0 0-12v12z",key:"j4l70d"}]],ms=D("contrast",us);const hs=[["path",{d:"M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5c-1.4 0-2.5-1.1-2.5-2.5V2",key:"125lnx"}],["path",{d:"M8.5 2h7",key:"csnxdl"}],["path",{d:"M14.5 16h-5",key:"1ox875"}]],ps=D("test-tube",hs),q={contrastLevel:"normal",motionPreference:"full",reduceTransparency:!1,fontSizeMultiplier:1,colorBlindnessType:"none",enhanceKeyboardNavigation:!0,provideLongDescriptions:!0,useColorBlindFriendlyPalette:!1,enableHoverEffects:!1,announceStateChanges:!1,showSkipLinks:!1},u=y.forwardRef(function({className:e="",showDashboard:i=!0,onConfigChange:n,enableTesting:h=!0,position:d="fixed",defaultOpen:O=!1,"aria-label":K,"data-testid":P},B){const f=Z(),[t,o]=g.useState(q),[G,F]=g.useState(O),[p,R]=g.useState("overview"),[$,H]=g.useState([]),[E,L]=g.useState(!1),c=t.motionPreference==="reduced",l=t.contrastLevel==="high",z=t.reduceTransparency,[U,W]=g.useState([{id:"contrast",title:"High Contrast & Visual",icon:s.jsx(ms,{className:"glass-w-5 glass-h-5"}),description:"Adjust contrast levels and visual accessibility settings",component:()=>s.jsx(C,{config:t,updateConfig:o,isHighContrast:l}),isExpanded:!1},{id:"motion",title:"Motion & Animation",icon:s.jsx(ss,{className:"glass-w-5 glass-h-5"}),description:"Control motion and animation preferences",component:()=>s.jsx(A,{config:t,updateConfig:o,isMotionReduced:c}),isExpanded:!1},{id:"screen-reader",title:"Screen Reader",icon:s.jsx(as,{className:"glass-w-5 glass-h-5"}),description:"Enhanced screen reader support and descriptions",component:()=>s.jsx(S,{config:t,updateConfig:o}),isExpanded:!1},{id:"keyboard",title:"Keyboard Navigation",icon:s.jsx(es,{className:"glass-w-5 glass-h-5"}),description:"Enhanced keyboard navigation and focus indicators",component:()=>s.jsx(T,{config:t,updateConfig:o}),isExpanded:!1}]);g.useEffect(()=>{n?.(t)},[t,n]);const J=g.useCallback(a=>{W(m=>m.map(v=>v.id===a?{...v,isExpanded:!v.isExpanded}:v))},[]),Q=g.useCallback(async()=>{L(!0);try{await new Promise(m=>setTimeout(m,b.DURATION.slower*1.5));const a=[{test:"WCAG 2.1 AA Compliance",status:"passed",score:95,details:"Most elements meet contrast requirements"},{test:"Keyboard Navigation",status:t.enhanceKeyboardNavigation?"passed":"warning",score:t.enhanceKeyboardNavigation?100:75,details:t.enhanceKeyboardNavigation?"All interactive elements are keyboard accessible":"Some elements may not be fully keyboard accessible"},{test:"Motion Preferences",status:"passed",score:100,details:"Motion preferences are respected"},{test:"Screen Reader Support",status:t.provideLongDescriptions?"passed":"warning",score:t.provideLongDescriptions?95:80,details:t.provideLongDescriptions?"Comprehensive descriptions provided":"Basic screen reader support active"},{test:"Color Blindness Support",status:t.useColorBlindFriendlyPalette?"passed":"info",score:t.useColorBlindFriendlyPalette?100:85,details:t.useColorBlindFriendlyPalette?"Color blind friendly palette active":"Standard color palette in use"}];H(a)}catch{H([])}finally{L(!1)}},[t]),X=[{id:"high-contrast",label:"High Contrast",active:l,onClick:()=>o(a=>({...a,contrastLevel:a.contrastLevel==="high"?"normal":"high"}))},{id:"reduce-motion",label:"Reduce Motion",active:c,onClick:()=>o(a=>({...a,motionPreference:a.motionPreference==="reduced"?"full":"reduced"}))},{id:"reduce-transparency",label:"Reduce Transparency",active:z,onClick:()=>o(a=>({...a,reduceTransparency:!a.reduceTransparency}))},{id:"large-text",label:"Large Text",active:t.fontSizeMultiplier>1,onClick:()=>o(a=>({...a,fontSizeMultiplier:a.fontSizeMultiplier>1?1:1.25}))}];if(!i)return null;const Y={position:d,top:d==="fixed"?"20px":void 0,right:d==="fixed"?"20px":void 0,zIndex:d==="fixed"?1e3:void 0};return s.jsxs("div",{ref:B,className:`glass-a11y-controller ${e}`,style:{...Y},"aria-label":K,"data-testid":P,children:[s.jsx(x.button,{onClick:()=>F(!G),className:I("glass-foundation-complete glass-w-14 glass-glass-h-14 glass-radius-full","flex items-center justify-center glass-shadow-lg hover:glass-shadow-xl","glass-transition glass-focus glass-press glass-magnet",{"glass-surface-dark glass-text-primary glass-border-primary":l,"glass-surface-transparent glass-text-secondary glass-border-subtle":!l,"rotate-45":G}),whileHover:{scale:1.05},whileTap:{scale:.95},"aria-label":"Toggle accessibility controls",title:"Accessibility Settings",children:s.jsx(cs,{className:"glass-w-6 glass-h-6"})}),s.jsx(V,{children:G&&s.jsxs(x.div,{initial:{opacity:0,scale:.9,y:-20},animate:f?{}:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.9,y:-20},transition:f?{duration:0}:{duration:c?b.DURATION.fast/1e3:b.DURATION.normal/1e3},className:I("glass-foundation-complete absolute glass-right-0 glass-top-16","glass-w-96 glass-max-h-80vh overflow-hidden glass-shadow-2xl glass-radius-2xl",{"glass-surface-dark glass-border-primary glass-text-primary":l,"glass-surface-translucent glass-border-subtle glass-text-secondary":!l}),style:{width:"min(24rem, calc(100vw - 2rem))",maxHeight:"min(80vh, 42rem)"},children:[s.jsxs("div",{className:"glass-p-6 glass-border-b glass-border-white/10",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between glass-mb-4",children:[s.jsxs("h2",{className:"glass-text-xl glass-font-semibold glass-flex glass-items-center glass-gap-2",children:[s.jsx(ls,{className:"glass-w-5 glass-h-5"}),"Accessibility Controls"]}),s.jsxs("div",{className:"glass-flex glass-gap-2",children:[s.jsx("button",{onClick:()=>{},className:`
                    ...
                    `,title:"Detect system preferences",children:s.jsx(ts,{className:"glass-w-4 glass-h-4"})}),s.jsx("button",{onClick:()=>o(q),className:`
                      p-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 glass-focus glass-touch-target glass-contrast-guard
                      ${l?"hover:bg-white/20 text-white":"hover:bg-black/10 text-gray-600"}
                    `,title:"Reset to defaults",children:s.jsx(rs,{className:"glass-w-4 glass-h-4"})})]})]}),s.jsx("div",{className:"glass-grid glass-grid-cols-2 glass-gap-2",children:X.map(a=>s.jsx(x.button,{onClick:a.onClick,whileHover:{scale:c?1:1.02},whileTap:{scale:c?1:.98},className:`
                    ...
                    `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1",children:[a.active&&s.jsx(is,{className:"glass-w-3 glass-h-3"}),s.jsx("span",{className:"glass-truncate",children:a.label})]})},a.id))})]}),s.jsxs("div",{className:"glass-flex-1 glass-overflow-y-auto",children:[s.jsxs("div",{className:"glass-flex glass-border-b glass-border-white/10",children:[s.jsx("button",{onClick:()=>R("overview"),className:`
                    ...
                    ${p==="overview"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                  `,children:"Overview"}),s.jsx("button",{onClick:()=>R("sections"),className:`
                    flex-1 px-4 py-3 text-sm font-medium transition-colors
                    focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-inset glass-focus glass-touch-target glass-contrast-guard
                    ${p==="sections"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                  `,children:"Settings"}),h&&s.jsx("button",{onClick:()=>R("testing"),className:`
                      flex-1 px-4 py-3 text-sm font-medium transition-colors
                      focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-inset glass-focus glass-touch-target glass-contrast-guard
                      ${p==="testing"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                    `,children:"Testing"})]}),s.jsxs("div",{className:"glass-p-6",children:[p==="overview"&&s.jsxs("div",{className:"glass-space-y-4",children:[s.jsxs("div",{className:"glass-grid glass-grid-cols-2 glass-gap-4 glass-text-sm",children:[s.jsxs("div",{className:`
                    ...
                    `,children:s.jsxs("div",{className:"glass-flex glass-items-start glass-gap-3",children:[s.jsx(ns,{className:"glass-w-5 glass-h-5 glass-mt-0-5 glass-flex-shrink-0"}),s.jsxs("div",{children:[s.jsx("p",{className:"glass-font-medium glass-mb-1",children:"WCAG 2.1 AAA Compliant"}),s.jsx("p",{className:"glass-text-sm glass-opacity-90",children:"This interface meets the highest accessibility standards and adapts to your needs."})]})]})})]}),p==="sections"&&s.jsx("div",{className:"glass-space-y-3",children:U.map(a=>{const m=a.component;return s.jsxs("div",{className:"glass-border glass-border-white/10 glass-radius-lg",children:[s.jsx("button",{onClick:()=>J(a.id),className:`
                            ...
                            `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-3",children:[a.icon,s.jsxs("div",{children:[s.jsx("div",{className:"glass-font-medium",children:a.title}),s.jsx("div",{className:`text-sm ${l?"text-white/70":"text-gray-500"}`,children:a.description})]})]}),a.isExpanded?s.jsx(os,{className:"glass-w-5 glass-h-5"}):s.jsx(gs,{className:"glass-w-5 glass-h-5"})]})}),s.jsx(V,{children:a.isExpanded&&s.jsx(x.div,{initial:{height:0,opacity:0},animate:f?{}:{height:"auto",opacity:1},exit:{height:0,opacity:0},transition:f?{duration:0}:{duration:c?b.DURATION.fast/1e3:b.DURATION.normal/1e3},className:"glass-border-t glass-border-white/10",children:s.jsx("div",{className:"glass-p-4",children:s.jsx(m,{})})})})]},a.id)})}),p==="testing"&&h&&s.jsxs("div",{className:"glass-space-y-4",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between",children:[s.jsx("h3",{className:"glass-font-medium",children:"Accessibility Tests"}),s.jsx(x.button,{onClick:Q,disabled:E,whileHover:{scale:c?1:1.05},whileTap:{scale:c?1:.95},className:`
                        ...
                        `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[s.jsx(ps,{className:"glass-w-4 glass-h-4"}),E?"Running...":"Run Tests"]})})]}),$.length>0&&s.jsx("div",{className:"glass-space-y-3",children:$.map((a,m)=>s.jsxs("div",{className:`
...
}`,...k.parameters?.docs?.source}}};const Rs=["Default","TestingMode","HighContrast","Minimal"];export{N as Default,j as HighContrast,k as Minimal,w as TestingMode,Rs as __namedExportsOrder,Gs as default};
