import{R as N,b as gs,r as d,j as s,d as f,m as v,c as y,e as B}from"./iframe-ChjdpTMc.js";import{f as R}from"./index-CLSxArU-.js";import{c as q}from"./createLucideIcon-DLakD0cH.js";import{M as ds}from"./move-CJ5ZWwv2.js";import{V as cs}from"./volume-2-B0slAGow.js";import{K as us}from"./keyboard-CA5YdZnp.js";import{S as ms}from"./settings-CmAkp67h.js";import{M as ps}from"./monitor-uO5J9H6J.js";import{R as hs}from"./rotate-ccw-q-jlkYNF.js";import{C as bs}from"./check-hjayNguG.js";import{I as xs}from"./info-D5SFlAHJ.js";import{C as ys}from"./chevron-up-BoDrH3KV.js";import{C as fs}from"./chevron-down-CVKfqJCG.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";const vs=[["circle",{cx:"16",cy:"4",r:"1",key:"1grugj"}],["path",{d:"m18 19 1-7-6 1",key:"r0i19z"}],["path",{d:"m5 8 3-3 5.5 3-2.36 3.5",key:"9ptxx2"}],["path",{d:"M4.24 14.5a5 5 0 0 0 6.88 6",key:"10kmtu"}],["path",{d:"M13.76 17.5a5 5 0 0 0-6.88-6",key:"2qq6rc"}]],Ns=q("accessibility",vs);const ws=[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"M12 18a6 6 0 0 0 0-12v12z",key:"j4l70d"}]],js=q("contrast",ws);const ks=[["path",{d:"M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5c-1.4 0-2.5-1.1-2.5-2.5V2",key:"125lnx"}],["path",{d:"M8.5 2h7",key:"csnxdl"}],["path",{d:"M14.5 16h-5",key:"1ox875"}]],Cs=q("test-tube",ks),F={contrastLevel:"normal",motionPreference:"full",reduceTransparency:!1,fontSizeMultiplier:1,colorBlindnessType:"none",enhanceKeyboardNavigation:!0,provideLongDescriptions:!0,useColorBlindFriendlyPalette:!1,enableHoverEffects:!1,announceStateChanges:!1,showSkipLinks:!1},p=N.forwardRef(function({className:e="",showDashboard:n=!0,onConfigChange:o,enableTesting:b=!0,position:c="fixed",defaultOpen:z=!1,compact:U=!1,contained:W=!1,preview:J=!1,maxHeight:D,maxWidth:H,density:Q="comfortable","aria-label":X,"data-testid":Y},Z){const w=gs(),[t,g]=d.useState(F),[E,ss]=d.useState(z),[x,V]=d.useState("overview"),[L,I]=d.useState([]),[O,K]=d.useState(!1),u=t.motionPreference==="reduced",l=t.contrastLevel==="high",as=t.reduceTransparency,[es,ls]=d.useState([{id:"contrast",title:"High Contrast & Visual",icon:s.jsx(js,{className:"glass-w-5 glass-h-5"}),description:"Adjust contrast levels and visual accessibility settings",component:()=>s.jsx(T,{config:t,updateConfig:g,isHighContrast:l}),isExpanded:!1},{id:"motion",title:"Motion & Animation",icon:s.jsx(ds,{className:"glass-w-5 glass-h-5"}),description:"Control motion and animation preferences",component:()=>s.jsx(M,{config:t,updateConfig:g,isMotionReduced:u}),isExpanded:!1},{id:"screen-reader",title:"Screen Reader",icon:s.jsx(cs,{className:"glass-w-5 glass-h-5"}),description:"Enhanced screen reader support and descriptions",component:()=>s.jsx(_,{config:t,updateConfig:g}),isExpanded:!1},{id:"keyboard",title:"Keyboard Navigation",icon:s.jsx(us,{className:"glass-w-5 glass-h-5"}),description:"Enhanced keyboard navigation and focus indicators",component:()=>s.jsx(G,{config:t,updateConfig:g}),isExpanded:!1}]);d.useEffect(()=>{o?.(t)},[t,o]);const ts=d.useCallback(a=>{ls(h=>h.map(j=>j.id===a?{...j,isExpanded:!j.isExpanded}:j))},[]),rs=d.useCallback(async()=>{K(!0);try{await new Promise(h=>setTimeout(h,f.DURATION.slower*1.5));const a=[{test:"WCAG 2.1 AA Compliance",status:"passed",score:95,details:"Most elements meet contrast requirements"},{test:"Keyboard Navigation",status:t.enhanceKeyboardNavigation?"passed":"warning",score:t.enhanceKeyboardNavigation?100:75,details:t.enhanceKeyboardNavigation?"All interactive elements are keyboard accessible":"Some elements may not be fully keyboard accessible"},{test:"Motion Preferences",status:"passed",score:100,details:"Motion preferences are respected"},{test:"Screen Reader Support",status:t.provideLongDescriptions?"passed":"warning",score:t.provideLongDescriptions?95:80,details:t.provideLongDescriptions?"Comprehensive descriptions provided":"Basic screen reader support active"},{test:"Color Blindness Support",status:t.useColorBlindFriendlyPalette?"passed":"info",score:t.useColorBlindFriendlyPalette?100:85,details:t.useColorBlindFriendlyPalette?"Color blind friendly palette active":"Standard color palette in use"}];I(a)}catch{I([])}finally{K(!1)}},[t]),is=[{id:"high-contrast",label:"High Contrast",active:l,onClick:()=>g(a=>({...a,contrastLevel:a.contrastLevel==="high"?"normal":"high"}))},{id:"reduce-motion",label:"Reduce Motion",active:u,onClick:()=>g(a=>({...a,motionPreference:a.motionPreference==="reduced"?"full":"reduced"}))},{id:"reduce-transparency",label:"Reduce Transparency",active:as,onClick:()=>g(a=>({...a,reduceTransparency:!a.reduceTransparency}))},{id:"large-text",label:"Large Text",active:t.fontSizeMultiplier>1,onClick:()=>g(a=>({...a,fontSizeMultiplier:a.fontSizeMultiplier>1?1:1.25}))}];if(!n)return null;const i=U||J||Q==="compact",P=typeof D=="number"?`${D}px`:D,ns=typeof H=="number"?`${H}px`:H,m=W||i,os={position:m?"relative":c,top:!m&&c==="fixed"?"20px":void 0,right:!m&&c==="fixed"?"20px":void 0,zIndex:!m&&c==="fixed"?1e3:void 0,maxHeight:P??(m?"220px":void 0),maxWidth:ns??(m?"320px":void 0),width:m?"100%":void 0,overflow:m?"hidden":void 0};return s.jsxs("div",{ref:Z,className:`glass-a11y-controller ${e}`,style:{...os},"aria-label":X,"data-testid":Y,children:[s.jsx(v.button,{onClick:()=>ss(!E),className:y("glass-foundation-complete glass-radius-full",i?"glass-w-10 glass-h-10":"glass-w-14 glass-glass-h-14","flex items-center justify-center glass-shadow-lg hover:glass-shadow-xl","glass-transition glass-focus glass-press glass-magnet",{"glass-surface-dark glass-text-primary glass-border-primary":l,"glass-surface-transparent glass-text-secondary glass-border-subtle":!l,"rotate-45":E}),whileHover:{scale:1.05},whileTap:{scale:.95},"aria-label":"Toggle accessibility controls",title:"Accessibility Settings",children:s.jsx(Ns,{className:"glass-w-6 glass-h-6"})}),s.jsx(B,{children:E&&s.jsxs(v.div,{initial:{opacity:0,scale:.9,y:-20},animate:w?{}:{opacity:1,scale:1,y:0},exit:{opacity:0,scale:.9,y:-20},transition:w?{duration:0}:{duration:u?f.DURATION.fast/1e3:f.DURATION.normal/1e3},className:y("glass-foundation-complete absolute glass-right-0",i?"glass-top-11":"glass-top-16","glass-w-96 glass-max-h-80vh overflow-hidden glass-shadow-2xl glass-radius-2xl",{"glass-surface-dark glass-border-primary glass-text-primary":l,"glass-surface-translucent glass-border-subtle glass-text-secondary":!l}),style:{width:i?"min(20rem, 100%)":"min(24rem, calc(100vw - 2rem))",maxHeight:P??(i?"220px":"min(80vh, 42rem)")},children:[s.jsxs("div",{className:y(i?"glass-p-3":"glass-p-6","glass-border-b glass-border-white/10"),children:[s.jsxs("div",{className:y("glass-flex glass-items-center glass-justify-between",i?"glass-mb-2":"glass-mb-4"),children:[s.jsxs("h2",{className:y("glass-font-semibold glass-flex glass-items-center glass-gap-2",i?"glass-text-sm":"glass-text-xl"),children:[s.jsx(ms,{className:"glass-w-5 glass-h-5"}),i?"A11y":"Accessibility Controls"]}),s.jsxs("div",{className:"glass-flex glass-gap-2",children:[s.jsx("button",{onClick:()=>{},className:`
                    ...
                    `,title:"Detect system preferences",children:s.jsx(ps,{className:"glass-w-4 glass-h-4"})}),s.jsx("button",{onClick:()=>g(F),className:`
                      p-2 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-blue-400 glass-focus glass-touch-target glass-contrast-guard
                      ${l?"hover:bg-white/20 text-white":"hover:bg-black/10 text-gray-600"}
                    `,title:"Reset to defaults",children:s.jsx(hs,{className:"glass-w-4 glass-h-4"})})]})]}),s.jsx("div",{className:y("glass-grid glass-grid-cols-2",i?"glass-gap-1":"glass-gap-2"),children:is.map(a=>s.jsx(v.button,{onClick:a.onClick,whileHover:{scale:u?1:1.02},whileTap:{scale:u?1:.98},className:`
                    ...
                    `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-1",children:[a.active&&s.jsx(bs,{className:"glass-w-3 glass-h-3"}),s.jsx("span",{className:"glass-truncate",children:a.label})]})},a.id))})]}),s.jsxs("div",{className:"glass-flex-1 glass-overflow-y-auto",children:[s.jsxs("div",{className:"glass-flex glass-border-b glass-border-white/10",children:[s.jsx("button",{onClick:()=>V("overview"),className:`
                    ...
                    ${x==="overview"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                  `,children:"Overview"}),s.jsx("button",{onClick:()=>V("sections"),className:`
                    flex-1 ${i?"px-2 py-2 text-xs":"px-4 py-3 text-sm"} font-medium transition-colors
                    focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-inset glass-focus glass-touch-target glass-contrast-guard
                    ${x==="sections"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                  `,children:"Settings"}),b&&s.jsx("button",{onClick:()=>V("testing"),className:`
                      flex-1 ${i?"px-2 py-2 text-xs":"px-4 py-3 text-sm"} font-medium transition-colors
                      focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-inset glass-focus glass-touch-target glass-contrast-guard
                      ${x==="testing"?l?"bg-white/20 text-white":"bg-white/10 text-blue-600":l?"text-white/70 hover:text-white":"text-gray-600 hover:text-gray-800"}
                    ...
                    `,children:s.jsxs("div",{className:"glass-flex glass-items-start glass-gap-3",children:[s.jsx(xs,{className:"glass-w-5 glass-h-5 glass-mt-0-5 glass-flex-shrink-0"}),s.jsxs("div",{children:[s.jsx("p",{className:"glass-font-medium glass-mb-1",children:"WCAG 2.1 AAA Compliant"}),s.jsx("p",{className:"glass-text-sm glass-opacity-90",children:"This interface meets the highest accessibility standards and adapts to your needs."})]})]})})]}),x==="sections"&&s.jsx("div",{className:"glass-space-y-3",children:es.map(a=>{const h=a.component;return s.jsxs("div",{className:"glass-border glass-border-white/10 glass-radius-lg",children:[s.jsx("button",{onClick:()=>ts(a.id),className:`
                            ...
                            `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-3",children:[a.icon,s.jsxs("div",{children:[s.jsx("div",{className:"glass-font-medium",children:a.title}),s.jsx("div",{className:`text-sm ${l?"text-white/70":"text-gray-500"}`,children:a.description})]})]}),a.isExpanded?s.jsx(ys,{className:"glass-w-5 glass-h-5"}):s.jsx(fs,{className:"glass-w-5 glass-h-5"})]})}),s.jsx(B,{children:a.isExpanded&&s.jsx(v.div,{initial:{height:0,opacity:0},animate:w?{}:{height:"auto",opacity:1},exit:{height:0,opacity:0},transition:w?{duration:0}:{duration:u?f.DURATION.fast/1e3:f.DURATION.normal/1e3},className:"glass-border-t glass-border-white/10",children:s.jsx("div",{className:"glass-p-4",children:s.jsx(h,{})})})})]},a.id)})}),x==="testing"&&b&&s.jsxs("div",{className:"glass-space-y-4",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-justify-between",children:[s.jsx("h3",{className:"glass-font-medium",children:"Accessibility Tests"}),s.jsx(v.button,{onClick:rs,disabled:O,whileHover:{scale:u?1:1.05},whileTap:{scale:u?1:.95},className:`
                        ...
                        `,children:s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2",children:[s.jsx(Cs,{className:"glass-w-4 glass-h-4"}),O?"Running...":"Run Tests"]})})]}),L.length>0&&s.jsx("div",{className:"glass-space-y-3",children:L.map((a,h)=>s.jsxs("div",{className:`
...
}`,...S.parameters?.docs?.source}}};const Ks=["Default","TestingMode","HighContrast","Minimal"];export{k as Default,A as HighContrast,S as Minimal,C as TestingMode,Ks as __namedExportsOrder,Os as default};
