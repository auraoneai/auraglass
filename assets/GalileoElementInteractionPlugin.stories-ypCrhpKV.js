import{j as s,r as l}from"./iframe-GrkikuRp.js";import"./preload-helper-PPVm8Dsz.js";const w={id:"auraElementInteraction"},f=e=>(console.log("Mock Aura plugin created with config:",e),{id:w.id,beforeInit:()=>console.log("Plugin beforeInit called"),afterInit:()=>console.log("Plugin afterInit called"),beforeUpdate:()=>console.log("Plugin beforeUpdate called"),afterUpdate:()=>console.log("Plugin afterUpdate called"),destroy:()=>console.log("Plugin destroy called"),config:{enabled:!0,magneticEffect:!0,rippleEffect:!0,glowEffect:!0,...e}}),C={title:"Data + Visualization/Aura Element Interaction Plugin",parameters:{layout:"centered",docs:{description:{component:"A chart plugin that adds interactive effects like magnetic attraction, ripple effects, and glow to chart elements."}}},argTypes:{enabled:{control:"boolean",description:"Enable/disable the plugin",defaultValue:!0},magneticEffect:{control:"boolean",description:"Enable magnetic attraction effect on hover",defaultValue:!0},rippleEffect:{control:"boolean",description:"Enable ripple effect on click",defaultValue:!0},glowEffect:{control:"boolean",description:"Enable glow effect",defaultValue:!0}},args:{enabled:!0,magneticEffect:!0,rippleEffect:!0,glowEffect:!0,stiffness:.1,damping:.8,mass:1,scale:1.1,glowIntensity:.5,rippleSpeed:.6,rippleSize:2}},t={render:e=>{const n={enabled:e.enabled??!0,magneticEffect:e.magneticEffect??!0,rippleEffect:e.rippleEffect??!0,glowEffect:e.glowEffect??!0,physics:{stiffness:200,damping:15,mass:.8},visual:{scale:1.05,glowIntensity:.3,rippleSpeed:.6,rippleSize:2}},i=f(n),g=({className:m,label:b,dotColor:x})=>{const c=l.useRef(null),[h,o]=l.useState({}),v=l.useCallback(d=>{const p=c.current;if(!p)return;const a=p.getBoundingClientRect(),E=d.clientX-a.left,N=d.clientY-a.top,u=Math.max(a.width,a.height)*.8;o({backgroundImage:`radial-gradient(${u}px ${u}px at ${E}px ${N}px, rgba(255,255,255,0.18), rgba(255,255,255,0.06) 45%, rgba(255,255,255,0) 60%)`})},[]),y=l.useCallback(()=>o({}),[]);return s.jsxs("div",{ref:c,onMouseMove:v,onMouseLeave:y,className:`chart-element relative overflow-hidden ${m}`,style:{transition:"transform 180ms ease, box-shadow 180ms ease"},children:[s.jsx("div",{className:"glass-absolute glass-inset-0 glass-pointer-events-none",style:{...h??{}}}),s.jsxs("div",{className:"glass-relative glass-text-center",children:[s.jsx("div",{className:"glass-w-8 glass-h-8 glass-radius-full glass-mx-auto glass-mb-2",style:{backgroundColor:x}}),s.jsx("p",{className:"glass-text-sm glass-font-medium",children:b})]})]})};return s.jsxs("div",{className:"glass-p-8 space-y-6",children:[s.jsxs("div",{className:"glass-text-center",children:[s.jsx("h3",{className:"glass-text-xl glass-font-semibold glass-mb-2",children:"Aura Element Interaction Plugin"}),s.jsx("p",{className:"glass-text-sm opacity-80 glass-mb-4",children:"Hover over and click the elements below to see the interactive effects."})]}),s.jsxs("div",{className:"glass-flex glass-flex-wrap glass-gap-4 glass-justify-center",children:[s.jsx(g,{className:"glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary dark:glass-gradient-primary dark:glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard",label:"Data Point 1",dotColor:"hsl(var(--glass-color-primary))"}),s.jsx(g,{className:"glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard",label:"Data Point 2",dotColor:"hsl(var(--glass-color-success))"}),s.jsx(g,{className:"glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary dark:glass-gradient-primary dark:glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard",label:"Data Point 3",dotColor:"#6366F1"})]}),s.jsxs("div",{className:"glass-surface-subtle/50 glass-glass-backdrop-blur glass-border glass-border-white/10 glass-radius-lg glass-p-4 glass-contrast-guard",children:[s.jsx("h4",{className:"glass-text-sm glass-font-semibold glass-mb-2",children:"Plugin Status:"}),s.jsxs("p",{className:"glass-text-xs opacity-75",children:[i.id," created successfully with effects: Magnetic, Ripple, Glow"]})]})]})},args:{enabled:!0,magneticEffect:!0,rippleEffect:!0,glowEffect:!0}},r={render:e=>{const n={enabled:e.enabled??!0,magneticEffect:!1,rippleEffect:!1,glowEffect:!1,physics:{stiffness:200,damping:15,mass:.8},visual:{scale:1.05,glowIntensity:.3,rippleSpeed:.6,rippleSize:2}},i=f(n);return s.jsxs("div",{className:"glass-p-8 space-y-6",children:[s.jsxs("div",{className:"glass-text-center",children:[s.jsx("h3",{className:"glass-text-xl glass-font-semibold glass-mb-2",children:"Disabled Effects"}),s.jsx("p",{className:"glass-text-sm opacity-80 glass-mb-4",children:"All interactive effects are disabled. Elements won't respond to hover or click."})]}),s.jsx("div",{className:"glass-flex glass-flex-wrap glass-gap-4 glass-justify-center",children:s.jsx("div",{className:"chart-element glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard",children:s.jsxs("div",{className:"glass-text-center",children:[s.jsx("div",{className:"glass-w-8 glass-h-8 glass-surface-red glass-radius-full glass-mx-auto glass-mb-2 glass-contrast-guard"}),s.jsx("p",{className:"glass-text-sm glass-font-medium",children:"No Effects"})]})})}),s.jsxs("div",{className:"glass-surface-subtle/50 glass-glass-backdrop-blur glass-border glass-border-white/10 glass-radius-lg glass-p-4 glass-contrast-guard",children:[s.jsx("h4",{className:"glass-text-sm glass-font-semibold glass-mb-2",children:"Plugin Status:"}),s.jsxs("p",{className:"glass-text-xs opacity-75",children:[i.id," created with all effects disabled"]})]})]})},args:{enabled:!0,magneticEffect:!1,rippleEffect:!1,glowEffect:!1}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  render: (args: PluginArgs) => {
    ...
    return <div className="glass-p-8 space-y-6">
        ...
        <div className="glass-flex glass-flex-wrap glass-gap-4 glass-justify-center">
          <LensCard className="glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary dark:glass-gradient-primary dark:glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard" label="Data Point 1" dotColor="hsl(var(--glass-color-primary))" />
          <LensCard className="glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard" label="Data Point 2" dotColor="hsl(var(--glass-color-success))" />
          <LensCard className="glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary dark:glass-gradient-primary dark:glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard" label="Data Point 3" dotColor="#6366F1" />
        </div>

        <div className="glass-surface-subtle/50 glass-glass-backdrop-blur glass-border glass-border-white/10 glass-radius-lg glass-p-4 glass-contrast-guard">
  ...
  render: (args: PluginArgs) => {
    ...
    return <div className="glass-p-8 space-y-6">
        ...
        <div className="glass-flex glass-flex-wrap glass-gap-4 glass-justify-center">
          <div className="chart-element glass-p-4 glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-glass-backdrop-blur glass-border glass-border-white/20 glass-radius-lg glass-cursor-pointer glass-contrast-guard">
            <div className="glass-text-center">
