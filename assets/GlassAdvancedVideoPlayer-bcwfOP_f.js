import{r as g,R as Ee,j as e,c as w,g as C}from"./iframe-Bw8wx5FH.js";import{u as Re}from"./GlassMediaProvider-BPvmZeow.js";import{G as ne}from"./GlassCore-gjZTrFxK.js";const S=s=>{if(isNaN(s))return"0:00";const d=Math.floor(s/3600),r=Math.floor(s%3600/60),i=Math.floor(s%60);return d>0?`${d}:${r.toString().padStart(2,"0")}:${i.toString().padStart(2,"0")}`:`${r}:${i.toString().padStart(2,"0")}`},Ae=s=>s.subtitles?.flatMap(d=>d.content?.map(r=>({...r,keywords:[],sentiment:"neutral"}))??[])??[],de=(s,d)=>!Number.isFinite(s)||!Number.isFinite(d)||d<=0?0:Math.max(0,Math.min(100,s/d*100)),qe=s=>!!s?.startsWith("data:video/"),Ie="data:image/svg+xml,"+encodeURIComponent(`
  ...
  `),_={...C({intent:"neutral",elevation:"level4",interactive:!0}),appearance:"none",WebkitAppearance:"none",border:"1px solid rgba(148, 163, 184, 0.42)",color:"#f8fafc",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.12), 0 12px 28px rgba(2,6,23,0.28)"},Le={...C({intent:"primary",elevation:"level4",interactive:!0}),appearance:"none",WebkitAppearance:"none",color:"#f8fafc",borderColor:"rgba(191, 219, 254, 0.72)",boxShadow:"inset 0 1px 0 rgba(255,255,255,0.12), 0 12px 28px rgba(2,6,23,0.28)"},Z={...C({intent:"neutral",elevation:"level4"}),color:"#f8fafc",border:"1px solid rgba(148, 163, 184, 0.34)",boxShadow:"0 18px 38px rgba(2, 6, 23, 0.42)"},_e={appearance:"none",WebkitAppearance:"none",color:"#38bdf8",accentColor:"#38bdf8"},$e=`
