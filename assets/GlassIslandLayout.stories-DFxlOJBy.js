...
}`,...J.parameters?.docs?.source}}};const rs=["Default","PhysicsEnabled","MinimalView","ConnectionFocus","DragAndResize","AutoArranged","ZoomedIn","ZoomedOut","GridEnabled","DenseLayout","SparseLayout","NoConnections","AllConnections","PhysicsWithConnections","PinnedIslands","MinimizedIslands","CategorizedIslands","LargeScale","PerformanceTest"];export{_ as AllConnections,q as AutoArranged,W as CategorizedIslands,A as ConnectionFocus,O as Default,$ as DenseLayout,Z as DragAndResize,E as GridEnabled,B as LargeScale,R as MinimalView,H as MinimizedIslands,Y as NoConnections,J as PerformanceTest,G as PhysicsEnabled,F as PhysicsWithConnections,U as PinnedIslands,X as SparseLayout,V as ZoomedIn,T as ZoomedOut,rs as __namedExportsOrder,os as default};
