import{j as s}from"./iframe-ChjdpTMc.js";import{G as t,a as c,b as g}from"./GlassTooltip-CXplfssE.js";import{I as h}from"./info-D5SFlAHJ.js";import{S as m}from"./shield-check-BG3iPouN.js";import{K as y}from"./keyboard-CA5YdZnp.js";import{c as x}from"./createLucideIcon-DLakD0cH.js";import"./preload-helper-PPVm8Dsz.js";import"./a11y-Dsb5vlCx.js";import"./MotionPreferenceContext-DQIb5qFV.js";import"./MotionFramer-Co8aYoJM.js";import"./utilsCore-CsXu-XBU.js";import"./OptimizedGlassCore-DN1SoNCt.js";import"./deviceCapabilities-CmFcsI28.js";const v=[["path",{d:"M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z",key:"edeuup"}]],b=x("mouse-pointer-2",v),o=({children:e,tone:a="overlay"})=>{const u=a==="blue"?"glass-surface-blue":a==="green"?"glass-surface-green":a==="red"?"glass-surface-red":"glass-surface-overlay";return s.jsx("button",{type:"button",className:`${u} glass-inline-flex glass-items-center glass-gap-2 glass-radius-lg glass-border glass-border-subtle glass-px-4 glass-py-2 glass-text-sm glass-font-medium glass-text-primary glass-focus glass-touch-target glass-contrast-guard`,children:e})},p=({children:e})=>s.jsx("div",{className:"glass-radius-lg glass-border glass-border-subtle glass-surface-overlay glass-px-3 glass-py-2 glass-text-sm glass-text-primary glass-shadow-lg",children:e}),K={title:"Surfaces/Modals/Glass Tooltip",component:t,parameters:{layout:"centered",previewSurface:"component",docs:{description:{component:"A glass tooltip for concise contextual help with responsive trigger layouts."}}},argTypes:{position:{control:{type:"select"},options:["top","right","bottom","left","auto"]},showDelay:{control:{type:"number",min:0,max:2e3,step:100}},hideDelay:{control:{type:"number",min:0,max:2e3,step:100}}},args:{position:"top",showDelay:0,hideDelay:100,maxWidth:"240px"}},r={render:e=>s.jsxs("div",{className:"glass-grid glass-gap-4 glass-justify-items-center",style:{width:"min(420px, calc(100vw - 64px))"},children:[s.jsx(t,{...e,content:"Changes are saved automatically.",children:s.jsxs(o,{tone:"blue",children:[s.jsx(h,{size:16,"aria-hidden":"true"}),"Save status"]})}),s.jsx(p,{children:"Changes are saved automatically."})]})},l={render:e=>s.jsx("div",{className:"glass-grid glass-grid-cols-1 sm:glass-grid-cols-2 glass-gap-4",style:{width:"min(520px, calc(100vw - 64px))"},children:["top","right","bottom","left"].map(a=>s.jsx(t,{position:a,content:`Tooltip on ${a}`,showDelay:e.showDelay,hideDelay:e.hideDelay,children:s.jsx(o,{tone:a==="left"?"green":"overlay",children:a})},a))})},n={render:e=>s.jsxs("div",{className:"glass-grid glass-gap-4 glass-justify-items-center",style:{width:"min(460px, calc(100vw - 64px))"},children:[s.jsx(t,{...e,content:s.jsxs("div",{className:"glass-grid glass-gap-2",children:[s.jsxs("div",{className:"glass-flex glass-items-center glass-gap-2 glass-font-semibold",children:[s.jsx(m,{size:16,"aria-hidden":"true"}),"Permission required"]}),s.jsx("p",{className:"glass-text-sm glass-text-secondary",children:"Admin approval is needed before this release can be promoted."})]}),children:s.jsxs(o,{tone:"green",children:[s.jsx(m,{size:16,"aria-hidden":"true"}),"Review access"]})}),s.jsx(p,{children:"Admin approval is needed before this release can be promoted."})]})},i={render:e=>s.jsxs("div",{className:"glass-flex glass-flex-wrap glass-justify-center glass-gap-4",style:{width:"min(560px, calc(100vw - 64px))"},children:[s.jsxs(t,{content:s.jsx("p",{children:"Keyboard shortcut: Command K"}),showDelay:e.showDelay,hideDelay:e.hideDelay,children:[s.jsx(c,{asChild:!0,children:s.jsxs(o,{children:[s.jsx(y,{size:16,"aria-hidden":"true"}),"Command menu"]})}),s.jsx(g,{children:s.jsx("p",{children:"Keyboard shortcut: Command K"})})]}),s.jsxs(t,{content:s.jsx("p",{children:"Pointer actions stay inside the current canvas."}),position:"right",showDelay:e.showDelay,hideDelay:e.hideDelay,children:[s.jsx(c,{asChild:!0,children:s.jsxs(o,{tone:"blue",children:[s.jsx(b,{size:16,"aria-hidden":"true"}),"Pointer mode"]})}),s.jsx(g,{children:s.jsx("p",{children:"Pointer actions stay inside the current canvas."})})]})]}),args:{children:null}},d={render:e=>s.jsxs("div",{className:"glass-grid glass-gap-4",style:{width:"min(520px, calc(100vw - 64px))"},children:[s.jsxs(t,{content:s.jsxs("div",{className:"glass-grid glass-gap-1",children:[s.jsx("div",{className:"glass-font-semibold",children:"Custom trigger"}),s.jsx("p",{className:"glass-text-sm glass-text-secondary",children:"Non-button triggers are styled and focusable for keyboard users."})]}),showDelay:e.showDelay,hideDelay:e.hideDelay,children:[s.jsx(c,{asChild:!0,children:s.jsx("div",{role:"button",tabIndex:0,className:"glass-radius-xl glass-border glass-border-subtle glass-surface-overlay glass-p-4 glass-text-sm glass-font-medium glass-text-primary glass-focus glass-touch-target glass-contrast-guard",children:"Focus or hover this custom glass trigger"})}),s.jsx(g,{children:s.jsx("p",{children:"Non-button triggers are styled and focusable for keyboard users."})})]}),s.jsx(p,{children:"Non-button triggers are styled and focusable for keyboard users."})]}),args:{children:null}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source}}};const I=["Default","Positions","RichContent","TooltipComponents","CustomTriggerContent"];export{d as CustomTriggerContent,r as Default,l as Positions,n as RichContent,i as TooltipComponents,I as __namedExportsOrder,K as default};
