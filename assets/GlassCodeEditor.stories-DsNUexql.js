...
2. Start development server: \`npm start\``,language:"markdown"}],onFileChange:(...i)=>console.log("Mock function called",...i)}),args:{}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  ...
  args: {}
}`,...C.parameters?.docs?.source}}};const oe=["Default","TypeScriptExample","ReadOnlyExample","WithFiles","MultiFileProject"];export{y as Default,C as MultiFileProject,j as ReadOnlyExample,b as TypeScriptExample,w as WithFiles,oe as __namedExportsOrder,re as default};
