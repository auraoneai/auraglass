import{j as s}from"./iframe-C1j_9pGm.js";import{c as m}from"./utilsCore-MhQK04QN.js";import"./preload-helper-PPVm8Dsz.js";const _=[{id:"skip-to-main",label:"Skip to main content",href:"#main-content"},{id:"skip-to-nav",label:"Skip to navigation",href:"#main-navigation"},{id:"skip-to-search",label:"Skip to search",href:"#search"}];function u({links:n=_,className:o,position:r="top-left",zIndex:i=9999,styles:a}){const e={"top-left":"left-4","top-center":"left-1/2 -translate-x-1/2","top-right":"right-4"},c=(t,f)=>{t.preventDefault();const y=f.replace("#",""),l=document.getElementById(y);l&&(l.focus(),document.activeElement!==l&&(l.setAttribute("tabindex","-1"),l.focus()),l.scrollIntoView({behavior:"smooth",block:"start"}))};return s.jsx("nav",{className:m("skip-links","fixed top-4","flex flex-col gap-2",e[r],o),style:{zIndex:i,...a},"aria-label":"Skip links",children:n.map(t=>s.jsx("a",{id:t.id,href:t.href,onClick:f=>c(f,t.href),className:m("absolute -left-[10000px] top-auto","w-[1px] h-[1px] overflow-hidden","focus:static focus:w-auto focus:h-auto","focus:overflow-visible","focus:inline-block","focus:px-4 focus:py-2","focus:bg-primary focus:text-primary-foreground","focus:rounded-md","focus:shadow-lg","focus:no-underline","focus:outline-none","focus:ring-2 focus:ring-primary focus:ring-offset-2","transition-all duration-200 ease-out","forced-colors:focus:forced-color-adjust-none","forced-colors:focus:outline forced-colors:focus:outline-2","forced-colors:focus:outline-[ButtonText]","glass-focus glass-touch-target glass-contrast-guard"),children:t.label},t.id))})}function k({children:n,className:o,id:r="main-content",...i}){return s.jsx("main",{id:r,className:o,role:"main","aria-label":"Main content",tabIndex:-1,...i,children:n})}function g({children:n,className:o,id:r="main-navigation",label:i="Main navigation",...a}){return s.jsx("nav",{id:r,className:o,role:"navigation","aria-label":i,tabIndex:-1,...a,children:n})}function h({children:n,className:o,id:r="search",...i}){return s.jsx("search",{id:r,className:o,role:"search","aria-label":"Search",tabIndex:-1,...i,children:n})}function v(){const n=a=>{const e=document.getElementById(a);e&&(e.hasAttribute("tabindex")||e.setAttribute("tabindex","-1"),e.focus(),e.scrollIntoView({behavior:"smooth",block:"start"}))},o=a=>{const e=document.createElement("a");return e.id=a.id,e.href=a.href,e.textContent=a.label,e.className="skip-link",e.addEventListener("click",c=>{c.preventDefault();const t=a.href.replace("#","");n(t)}),e};return{skipToElement:n,createSkipLink:o,addSkipLink:(a,e)=>{const c=e||document.body,t=o(a);return c.insertBefore(t,c.firstChild),t},removeSkipLink:a=>{const e=document.getElementById(a);e&&e.remove()}}}try{u.displayName="SkipLinks",u.__docgenInfo={description:`SkipLinks component
...
Wrapper for search with proper ARIA attributes`,displayName:"SearchLandmark",props:{}}}catch{}try{v.displayName="useSkipLinks",v.__docgenInfo={description:`Custom skip link hook
Programmatically manage skip links`,displayName:"useSkipLinks",props:{}}}catch{}const L={title:"Foundations/Liquid Glass Primitives/Skip Links",component:u,parameters:{layout:"centered",docs:{description:{component:"A glass morphism skiplinks component."}}},argTypes:{},args:{}},p={args:{}},d={render:n=>s.jsx("div",{className:"flex flex-wrap gap-4",children:s.jsx(u,{...n,children:"Default"})}),args:{}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {}
