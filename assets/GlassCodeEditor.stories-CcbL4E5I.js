...
2. Start development server: \`npm start\``,language:"markdown"}],onFileChange:(...c)=>console.log("Mock function called",...c)}),args:{}};b.parameters={...b.parameters,docs:{...b.parameters?.docs,source:{originalSource:`{
  ...
  args: {}
}`,...N.parameters?.docs?.source}}};const oe=["Default","TypeScriptExample","ReadOnlyExample","WithFiles","MultiFileProject"];export{b as Default,N as MultiFileProject,w as ReadOnlyExample,j as TypeScriptExample,C as WithFiles,oe as __namedExportsOrder,re as default};
