import{r as o,j as s,e as qs,m as Ds}from"./iframe-BVJcMDDP.js";import{f as as}from"./index-CLSxArU-.js";import{u as Es}from"./useMotionPreference-BkM4ESLL.js";import{u as Os}from"./a11y-BlwVq89o.js";import{u as Ts}from"./soundDesign-CJVcGcCH.js";import{O as _s}from"./OptimizedGlassCore-DzSkF5wV.js";import{H as $s}from"./house-CelAzImX.js";import{U as Ps}from"./user-Cs5ZanR4.js";import{S as As}from"./settings-CnHmj4Pv.js";import{M as Fs}from"./mail-CFXAWixH.js";import{S as Bs}from"./star-DF9ZVisb.js";import{F as Us}from"./file-text-DiRKVlbj.js";import{T as Xs,G as Ys}from"./trophy-B61a_gzf.js";import{S as Qs}from"./search-_vNyc2cW.js";import{C as Js}from"./calendar-6v9RnRPZ.js";import{B as Ks}from"./bell-C2KW2S_w.js";import{C as Zs}from"./clock-CCO4i6Zy.js";import{I as hs}from"./image-C4t7N-rQ.js";import{V as ps}from"./video-BMochvnz.js";import{M as se}from"./music-BZ3xGYwS.js";import{C as ee}from"./camera-D_-ehbh8.js";import"./preload-helper-PPVm8Dsz.js";import"./index-ByImX2pa.js";import"./deviceCapabilities-9ai_ldnn.js";import"./createLucideIcon-DER72wqv.js";const X=o.forwardRef(({items:m=[],containerWidth:y=800,containerHeight:is=600,goldenRatio:u=1.618,subdivisionLevels:ts=4,spacing:x=8,animateLayout:ae=!0,showGrid:fs=!1,showRatioLines:ys=!0,showEmptyLabels:xs=!1,responsive:h=!0,onItemClick:rs,onItemHover:ns,onLayoutChange:ls,glassConfig:vs={},soundEnabled:v=!0,compact:r=!1,contained:bs=!1,maxHeight:ws,className:js="",style:Ls={},...Ns},Ss)=>{const[Rs,Gs]=o.useState(null),[Hs,Ws]=o.useState(null),[n,Cs]=o.useState({width:y,height:is}),J=o.useRef(null),{prefersReducedMotion:Is}=Es(),ks=Os(),{play:b}=Ts(),p=r?360:y,g=r?220:is,w=r?Math.min(ts,3):ts,os=r?!1:fs,ds=r?!1:ys,K=ws??(r||bs?g:void 0);o.useEffect(()=>{if(!h||!J.current)return;const e=new ResizeObserver(t=>{for(let a of t){const{width:c,height:i}=a.contentRect;Cs({width:c,height:i})}});return e.observe(J.current),()=>e.disconnect()},[h]);const cs=o.useCallback(()=>{const e=[],t=[{x:0,y:0,width:r?p:n.width,height:r?g:n.height,level:0}];for(;t.length>0&&e.length<Math.pow(2,w);){const a=t.shift();if(a.level>=w){e.push({...a,ratio:a.width/a.height});continue}if(a.width>a.height){const i=a.width/u,l=a.width-i;t.push({x:a.x,y:a.y,width:i,height:a.height,level:a.level+1}),t.push({x:a.x+i,y:a.y,width:l,height:a.height,level:a.level+1})}else{const i=a.height/u,l=a.height-i;t.push({x:a.x,y:a.y,width:a.width,height:i,level:a.level+1}),t.push({x:a.x,y:a.y+i,width:a.width,height:l,level:a.level+1})}}return e},[r,n,g,w,p,u]),gs=o.useCallback(e=>{const t=[...m].sort((i,l)=>(l.priority||0)-(i.priority||0));return[...e].sort((i,l)=>l.width*l.height-i.width*i.height).map((i,l)=>{const j=t[l];return{...i,item:j||void 0}})},[m]),Z=o.useMemo(()=>{const e=cs(),t=gs(e);return ls?.(t),t},[cs,gs,ls]),ms=o.useCallback(()=>{const e=[],t=n.width/2,a=n.height/2,c=Math.min(n.width,n.height)/3;for(let i=0;i<200;i++){const l=i*.2,j=c/20*Math.pow(u,l/(Math.PI*2)),ss=t+j*Math.cos(l),es=a+j*Math.sin(l);ss>=0&&ss<=n.width&&es>=0&&es<=n.height&&e.push({x:ss,y:es})}return e},[n,u]),Ms=o.useMemo(()=>ms(),[ms]),zs=o.useCallback(e=>{Ws(e.id),rs?.(e),v&&b("click")},[rs,v,b]),us=o.useCallback(e=>{Gs(e?.id||null),ns?.(e),v&&e&&b("hover")},[ns,v,b]),Vs=()=>({hidden:{scale:0,opacity:0},visible:e=>({scale:1,opacity:1,transition:{type:"spring",tension:300,friction:25,delay:Is?0:e*.05}}),hover:{scale:1.02,transition:{type:"spring",tension:400,friction:20}},selected:{scale:1.05,transition:{type:"spring",tension:400,friction:20}}});return s.jsxs(_s,{ref:Ss,className:`glass-golden-ratio-grid relative overflow-auto ${js}`,style:{width:h?"100%":p,minWidth:h||r?void 0:p,height:r?g:h?"100%":g,minHeight:g,maxHeight:typeof K=="number"?`${K}px`:K,overflowX:"auto",overflowY:"auto",...Ls},glassConfig:{blur:12,opacity:.95,saturation:1.05,brightness:1.02,...vs},role:"grid","aria-label":"Golden ratio layout grid",id:ks,...Ns,children:[s.jsxs("div",{ref:J,className:"glass-absolute glass-inset-0",style:{width:r?p:n.width,height:r?g:n.height},children:[ds&&s.jsx("svg",{className:"glass-absolute glass-inset-0 glass-pointer-events-none",width:n.width,height:n.height,children:s.jsx("path",{d:`M ${Ms.map(e=>`${e.x},${e.y}`).join(" L ")}`,stroke:"rgba(255, 215, 0, 0.3)",strokeWidth:"2",fill:"none",strokeDasharray:"5,5"})}),os&&s.jsx("svg",{className:"glass-absolute glass-inset-0 glass-pointer-events-none",width:n.width,height:n.height,children:Z.map((e,t)=>s.jsx("rect",{x:e.x,y:e.y,width:e.width,height:e.height,stroke:"rgba(var(--glass-color-white) / var(--glass-opacity-20))",strokeWidth:"1",fill:"none",strokeDasharray:"3,3"},`grid-${t}`))}),s.jsx(qs,{children:Z.map((e,t)=>{const a=!!e.item,c=a&&Rs===e.item.id,i=a&&Hs===e.item.id;return s.jsxs(Ds.div,{className:`
                    absolute overflow-visible
                    ${a?"cursor-pointer":"cursor-default"}
                  `,style:{left:e.x+x/2,top:e.y+x/2,width:e.width-x,height:e.height-x,boxSizing:"border-box"},custom:t,variants:Vs(),initial:"hidden",animate:i?"selected":c?"hover":"visible",exit:"hidden",onMouseEnter:()=>a&&us(e.item),onMouseLeave:()=>us(null),onClick:()=>a&&zs(e.item),role:"row",children:[a?s.jsx("div",{className:`
...
}`,...U.parameters?.docs?.source}}};const We=["Default","MediaGallery","Dashboard","ContentLayout","ClassicGoldenRatio","ModifiedRatio","SilverRatio","ShallowSubdivision","DeepSubdivision","WideSpacing","TightSpacing","WithGridLines","NoGridLines","SpiralOnly","GridOnly","NoAnimation","Responsive","LargeContainer","SmallContainer","SquareContainer","WideContainer","TallContainer","CustomGlass","MinimalGlass","InteractiveDemo"];export{G as ClassicGoldenRatio,R as ContentLayout,F as CustomGlass,S as Dashboard,I as DeepSubdivision,L as Default,D as GridOnly,U as InteractiveDemo,T as LargeContainer,N as MediaGallery,B as MinimalGlass,H as ModifiedRatio,E as NoAnimation,V as NoGridLines,O as Responsive,C as ShallowSubdivision,W as SilverRatio,_ as SmallContainer,q as SpiralOnly,$ as SquareContainer,A as TallContainer,M as TightSpacing,P as WideContainer,k as WideSpacing,z as WithGridLines,We as __namedExportsOrder,He as default};
