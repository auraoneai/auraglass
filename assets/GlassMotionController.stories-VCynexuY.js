import{r as o,j as s,c as Q,R as ns}from"./iframe-DinEdlu4.js";import{u as X,a as _}from"./a11y-BZVU29oS.js";import{u as K}from"./MotionPreferenceContext-C6zfnLSu.js";import"./preload-helper-PPVm8Dsz.js";const es=o.createContext(void 0),ts={enabled:!1,speed:1,reduceMotion:!0,animate:async()=>{},batchAnimate:async()=>{}},U=()=>o.useContext(es)??ts,ss={linear:e=>e,easeIn:e=>e*e,easeOut:e=>e*(2-e),easeInOut:e=>e<.5?2*e*e:-1+(4-2*e)*e,bounce:e=>e<1/2.75?7.5625*e*e:e<2/2.75?7.5625*(e-=1.5/2.75)*e+.75:e<2.5/2.75?7.5625*(e-=2.25/2.75)*e+.9375:7.5625*(e-=2.625/2.75)*e+.984375,elastic:e=>e===0?0:e===1?1:-Math.pow(2,-10*e)*Math.sin((e-.1)*5*Math.PI)+1},k=o.forwardRef(({enabled:e=!0,speed:g=1,reduceMotion:j=!1,respectMotionPreference:n=!0,children:I,className:G,"aria-label":u,...b},y)=>{const[p,c]=o.useState(!1),f=K(),v=X("motion-controller"),w=n?j||f.prefersReducedMotion:j,N=async(t,l)=>{if(!e||w){w&&(M(t,l.type,l.direction||"center"),_(`Animation ${l.type} applied instantly due to reduced motion preference`,"polite"));return}return c(!0),_(`Starting ${l.type} animation`,"polite"),new Promise(m=>{const{type:a,direction:i="center",duration:P=1e3,delay:d=0,easing:S="easeOut",repeat:C=0,yoyo:V=!1,amplitude:Z=1,frequency:B=1}=l,J=P*g;let q,E=0;const T=R=>{if(q||(q=R),R-q<d){requestAnimationFrame(T);return}const L=R-q-d,O=Math.min(L/J,1),as=ss[S](O);if(r(t,a,i,as,Z,B),O<1)requestAnimationFrame(T);else if(E++,E<=C){if(q=R,V){const ls=x();requestAnimationFrame(ls);return}}else c(!1),_(`Animation ${l.type} completed`,"polite"),m()};requestAnimationFrame(T)})},h=async t=>{if(!e||w){w&&(t.forEach(({element:m,config:a})=>{M(m,a.type,a.direction||"center")}),_(`${t.length} animations applied instantly due to reduced motion preference`,"polite"));return}c(!0),_(`Starting batch animation of ${t.length} elements`,"polite");const l=t.map(({element:m,config:a})=>N(m,a));await Promise.all(l),c(!1),_("Batch animation completed","polite")},x=(t,l,m,a,i,P,d)=>S=>{},r=(t,l,m,a,i,P)=>{const d={};switch(l){case"fadeIn":case"fadeOut":d.opacity=l==="fadeIn"?a.toString():(1-a).toString();break;case"slideIn":case"slideOut":const S=100,C=l==="slideIn"?1-a:a;switch(m){case"up":d.transform=`translateY(${S*C}px)`;break;case"down":d.transform=`translateY(-${S*C}px)`;break;case"left":d.transform=`translateX(${S*C}px)`;break;case"right":d.transform=`translateX(-${S*C}px)`;break}break;case"scaleIn":case"scaleOut":const V=l==="scaleIn"?0:1,B=V+((l==="scaleIn"?1:0)-V)*a;d.transform=`scale(${B})`;break;case"bounce":const J=i*50,q=ss.bounce(a);d.transform=`translateY(${J*(1-q)}px)`;break;case"shake":const E=i*10,T=Math.sin(a*P*Math.PI*2)*E;d.transform=`translateX(${T}px)`;break;case"pulse":const R=1+Math.sin(a*P*Math.PI*2)*i*.1;d.transform=`scale(${R})`;break;case"rotate":const L=a*360*P;d.transform=`rotate(${L}deg)`;break;case"flip":const O=a*180;d.transform=`rotateY(${O}deg)`;break}Object.assign(t.style,d)},M=(t,l,m)=>{const a={};switch(l){case"fadeIn":a.opacity="1";break;case"fadeOut":a.opacity="0";break;case"slideIn":case"scaleIn":a.transform="none",a.opacity="1";break;case"slideOut":case"scaleOut":a.opacity="0";break;default:a.opacity="1",a.transform="none";break}Object.assign(t.style,a)};return s.jsx("div",{ref:y,className:G,id:v,"aria-label":u||(p?"Animation in progress":"Animation controller"),"aria-busy":p,role:"region",...b,children:s.jsx(es.Provider,{value:{enabled:e&&!w,speed:g,reduceMotion:w,animate:N,batchAnimate:h},children:I})})});k.displayName="GlassMotionController";const A=o.forwardRef(({animation:e,children:g,className:j="",trigger:n="mount",respectMotionPreference:I=!0,"aria-label":G,...u},b)=>{const{animate:y,enabled:p,reduceMotion:c}=U(),f=o.useRef(null),[v,w]=o.useState(!1),[N,h]=o.useState(!1),x=K(),r=X("animated"),M=i=>{f.current=i,typeof b=="function"?b(i):b&&(b.current=i)},t=I?c||x.prefersReducedMotion:c;o.useEffect(()=>{!p||!e||!f.current||v||n==="mount"&&(h(!0),y(f.current,e).then(()=>{w(!0),h(!1)}).catch(()=>{h(!1)}))},[y,e,p,n,v]);const l=async()=>{if(!(!p||!e||!f.current)&&n==="click"){h(!0);try{await y(f.current,e)}finally{h(!1)}}},m=async()=>{if(!(!p||!e||!f.current||n!=="hover")){h(!0);try{await y(f.current,e)}finally{h(!1)}}},a=i=>{n==="click"&&(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),l())};return s.jsxs("div",{ref:M,id:r,className:j,onClick:n==="click"?l:void 0,onMouseEnter:n==="hover"?m:void 0,onKeyDown:n==="click"?a:void 0,tabIndex:n==="click"?0:void 0,role:n==="click"?"button":void 0,"aria-label":G||(n==="click"?"Animated interactive element":void 0),"aria-busy":N,"aria-describedby":t?`${r}-motion-notice`:void 0,...u,children:[g,t&&s.jsx("div",{id:`${r}-motion-notice`,className:Q("glass-sr-only"),children:"Motion animations are disabled due to accessibility preferences"})]})});A.displayName="GlassAnimated";const $=o.forwardRef(({children:e,staggerDelay:g=100,className:j="",respectMotionPreference:n=!0,"aria-label":I,...G},u)=>{const{batchAnimate:b,enabled:y,reduceMotion:p}=U(),c=o.useRef(null),[f,v]=o.useState(!1),w=K(),N=X("animation-sequence"),h=r=>{c.current=r,typeof u=="function"?u(r):u&&(u.current=r)},x=n?p||w.prefersReducedMotion:p;return o.useEffect(()=>{if(!y||!c.current)return;const r=c.current.children,M=Array.from(r).map((t,l)=>({element:t,config:{type:"fadeIn",direction:"up",duration:600,delay:x?0:l*g,easing:"easeOut"}}));v(!0),b(M).then(()=>v(!1)).catch(()=>v(!1))},[b,y,g,x]),s.jsxs("div",{ref:h,id:N,className:j,role:"region","aria-label":I||"Animation sequence","aria-busy":f,"aria-describedby":x?`${N}-motion-notice`:void 0,...G,children:[e,x&&s.jsx("div",{id:`${N}-motion-notice`,className:Q("glass-sr-only"),children:"Sequential animations are disabled due to accessibility preferences"})]})});$.displayName="GlassAnimationSequence";const z=o.forwardRef(({timeline:e,children:g,className:j="",respectMotionPreference:n=!0,"aria-label":I,...G},u)=>{const{animate:b,enabled:y,reduceMotion:p}=U(),c=o.useRef(null),[f,v]=o.useState(!1),w=K(),N=X("animation-timeline"),h=r=>{c.current=r,typeof u=="function"?u(r):u&&(u.current=r)},x=n?p||w.prefersReducedMotion:p;return o.useEffect(()=>{if(!y||!c.current)return;v(!0);let r=[];e.forEach(({selector:M,animation:t,startTime:l=0})=>{const m=c.current?.querySelector(M);if(m){const a=new Promise(i=>{setTimeout(()=>{b(m,t).then(i).catch(i)},x?0:l)});r.push(a)}}),Promise.all(r).then(()=>v(!1)).catch(()=>v(!1))},[b,y,e,x]),s.jsxs("div",{ref:h,id:N,className:j,role:"region","aria-label":I||"Animation timeline","aria-busy":f,"aria-describedby":x?`${N}-motion-notice`:void 0,...G,children:[g,x&&s.jsx("div",{id:`${N}-motion-notice`,className:Q("glass-sr-only"),children:"Timeline animations are disabled due to accessibility preferences"})]})});z.displayName="GlassAnimationTimeline";try{k.displayName="GlassMotionController",k.__docgenInfo={description:"",displayName:"GlassMotionController",props:{enabled:{defaultValue:{value:"true"},description:"Whether animations are globally enabled",name:"enabled",required:!1,type:{name:"boolean | undefined"}},speed:{defaultValue:{value:"1"},description:"Global animation duration multiplier",name:"speed",required:!1,type:{name:"number | undefined"}},reduceMotion:{defaultValue:{value:"false"},description:"Whether to reduce motion for accessibility",name:"reduceMotion",required:!1,type:{name:"boolean | undefined"}},respectMotionPreference:{defaultValue:{value:"true"},description:"Whether to respect motion preferences",name:"respectMotionPreference",required:!1,type:{name:"boolean | undefined"}},children:{defaultValue:null,description:"Children to animate",name:"children",required:!0,type:{name:"ReactNode"}},className:{defaultValue:{value:""},description:"Additional CSS class",name:"className",required:!1,type:{name:"string | undefined"}},"aria-label":{defaultValue:null,description:"ARIA label for the motion controller",name:"aria-label",required:!1,type:{name:"string | undefined"}}}}}catch{}try{A.displayName="GlassAnimated",A.__docgenInfo={description:"",displayName:"GlassAnimated",props:{animation:{defaultValue:null,description:"",name:"animation",required:!1,type:{name:"AnimationConfig | undefined"}},className:{defaultValue:{value:""},description:"",name:"className",required:!1,type:{name:"string | undefined"}},trigger:{defaultValue:{value:"mount"},description:"",name:"trigger",required:!1,type:{name:"enum",value:[{value:"undefined"},{value:'"hover"'},{value:'"manual"'},{value:'"click"'},{value:'"mount"'}]}},respectMotionPreference:{defaultValue:{value:"true"},description:"Whether to respect motion preferences",name:"respectMotionPreference",required:!1,type:{name:"boolean | undefined"}},"aria-label":{defaultValue:null,description:"ARIA label for the animated element",name:"aria-label",required:!1,type:{name:"string | undefined"}}}}}catch{}try{$.displayName="GlassAnimationSequence",$.__docgenInfo={description:"",displayName:"GlassAnimationSequence",props:{staggerDelay:{defaultValue:{value:"100"},description:"",name:"staggerDelay",required:!1,type:{name:"number | undefined"}},className:{defaultValue:{value:""},description:"",name:"className",required:!1,type:{name:"string | undefined"}},respectMotionPreference:{defaultValue:{value:"true"},description:"Whether to respect motion preferences",name:"respectMotionPreference",required:!1,type:{name:"boolean | undefined"}},"aria-label":{defaultValue:null,description:"ARIA label for the sequence",name:"aria-label",required:!1,type:{name:"string | undefined"}}}}}catch{}try{z.displayName="GlassAnimationTimeline",z.__docgenInfo={description:"",displayName:"GlassAnimationTimeline",props:{timeline:{defaultValue:null,description:"",name:"timeline",required:!0,type:{name:"{ selector: string; animation: AnimationConfig; startTime?: number | undefined; }[]"}},className:{defaultValue:{value:""},description:"",name:"className",required:!1,type:{name:"string | undefined"}},respectMotionPreference:{defaultValue:{value:"true"},description:"Whether to respect motion preferences",name:"respectMotionPreference",required:!1,type:{name:"boolean | undefined"}},"aria-label":{defaultValue:null,description:"ARIA label for the timeline",name:"aria-label",required:!1,type:{name:"string | undefined"}}}}}catch{}const cs={title:"Foundations/Motion/Glass Motion Controller",component:k,parameters:{layout:"centered",previewSurface:"media",docs:{description:{component:"A glass morphism glassmotioncontroller component."}}},decorators:[e=>s.jsxs("div",{className:"motion-controller-story-shell",style:{width:"100%",maxWidth:920,maxHeight:"min(720px, calc(100vh - 64px))",overflow:"auto",borderRadius:20,border:"1px solid rgba(255, 255, 255, 0.24)",background:"linear-gradient(135deg, rgba(15, 23, 42, 0.98), rgba(17, 94, 89, 0.92))",boxShadow:"0 28px 72px rgba(2, 6, 23, 0.44)",color:"#f8fafc",padding:"clamp(16px, 3vw, 28px)"},children:[s.jsx("style",{children:`
...
}`,...Y.parameters?.docs?.source}}};const gs=["Default","Variants","AnimationSequence","AnimationTimeline","InteractiveSequence"];export{W as AnimationSequence,H as AnimationTimeline,D as Default,Y as InteractiveSequence,F as Variants,gs as __namedExportsOrder,cs as default};
