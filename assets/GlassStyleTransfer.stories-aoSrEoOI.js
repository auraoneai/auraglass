...
}`,...$.parameters?.docs?.source}}};const Ve=["Default","ArtisticStyles","PhotographicStyles","AbstractStyles","HighStrengthTransfer","LowStrengthTransfer","ColorPreservation","HighResolution","MultiplyBlendMode","OverlayBlendMode","MinimalInterface","StyleLibraryOnly","AdvancedControlsOnly","ProcessingState","DisabledRealTime","DetailEnhancement","SoftLightBlend","ScreenBlendMode","LowResolutionFast","CustomStyleModel"];export{A as AbstractStyles,V as AdvancedControlsOnly,P as ArtisticStyles,L as ColorPreservation,$ as CustomStyleModel,N as Default,F as DetailEnhancement,B as DisabledRealTime,U as HighResolution,T as HighStrengthTransfer,_ as LowResolutionFast,I as LowStrengthTransfer,G as MinimalInterface,D as MultiplyBlendMode,R as OverlayBlendMode,k as PhotographicStyles,O as ProcessingState,E as ScreenBlendMode,H as SoftLightBlend,q as StyleLibraryOnly,Ve as __namedExportsOrder,qe as default};
