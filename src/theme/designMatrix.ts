...
export const DESIGN_MATRIX: Record<PersonaId, PersonaConfig> = {
  ...
  "midnight-meridian": {
    ...
    spacing: {
      ...
      overlayBlur: "24px",
      layoutPattern:
        "Productivity split pane with task queues + KPI strip"
    },
    motion: {
      entry: "280ms",
      hover: "160ms",
  ...
  "solar-apex": {
    ...
    spacing: {
      ...
      overlayBlur: "28px",
      layoutPattern:
        "Executive dashboard with 12-column oversight grid"
    },
    motion: {
      entry: "340ms",
      hover: "200ms",
  ...
  "violet-nebula": {
    ...
    spacing: {
      ...
      overlayBlur: "36px",
      layoutPattern:
        "Scenario canvas with 4-column narrative cards"
    },
    motion: {
      entry: "360ms",
      hover: "220ms",
  ...
  "aurora-noir": {
    ...
    spacing: {
      ...
      overlayBlur: "30px",
      layoutPattern:
        "Mission command board with timeline rail"
    },
    motion: {
      entry: "300ms",
      hover: "190ms",
  ...
  "helios-foundry": {
    ...
    spacing: {
      ...
      overlayBlur: "28px",
      layoutPattern:
        "Industrial twin layout with control sidebar"
    },
    motion: {
      entry: "260ms",
      hover: "150ms",
  ...
  "glacier-morn": {
    ...
    spacing: {
      ...
      overlayBlur: "26px",
      layoutPattern:
        "Clinical checklist layout with metrics spine"
    },
    motion: {
      entry: "300ms",
      hover: "170ms",
  ...
  "terra-inflect": {
    meta: {
      ...
      id: "terra-inflect",
      primaryContext:
        "Cyber defense war rooms, incident response workflows",
      paletteAnchor:
  ...
  "lumen-veil": {
    ...
    spacing: {
      ...
      overlayBlur: "32px",
      layoutPattern:
        "Storyboard flow with media spotlight strip"
    },
    motion: {
      entry: "340ms",
      hover: "210ms",
  ...
  "nimbus-relay": {
    ...
    colors: {
      ...
      shadow: {
        panel: "0 28px 64px -30px rgba(100,196,255,0.40)"
      },
      focus: {
        ring: "0 0 0 3px rgba(100,196,255,0.32)"
      }
    },
    typography: {
      display: {
    ...
    spacing: {
      ...
      overlayBlur: "24px",
      layoutPattern:
        "Collaboration tiles with live presence bar"
    },
    motion: {
      entry: "280ms",
      hover: "170ms",
...
export const PERSONA_LIST = PERSONA_IDS.map(
  (id) => DESIGN_MATRIX[id]
);
