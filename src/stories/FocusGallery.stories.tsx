...
const items = [
  ['Focus Indicators', 'Visible keyboard focus for interactive glass controls.'],
  ['Contrast Guard', 'Story-level readability checks across light, dark, and liquid modes.'],
  ['Skip Links', 'Navigation affordances for app shells and dense templates.'],
  ['A11y Provider', 'Preference wiring for reduced motion and high-contrast previews.'],
];

const FocusGallery = () => <CategoryGallery title="Focus Gallery" kicker="Accessibility" items={items} />;
...
const CategoryGallery = ({ title, kicker, items }: { title: string; kicker: string; items: string[][] }) => (
  <main style={styles.page}>
    <section style={styles.header}>
      ...
      <p style={styles.copy}>Accessibility stories make focus, contrast, and keyboard behavior visible without crowding the preview.</p>
    </section>
...
const meta: Meta<typeof FocusGallery> = {
  title: 'Reference/Category Galleries/Focus Gallery',
