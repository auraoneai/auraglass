...
describe("GlassBreadcrumb", () => {
  ...
  describe("ARIA Attributes", () => {
    ...
    it("has accessible name", () => {
      render(
        <GlassBreadcrumb aria-label="Main navigation">
          <span>Home</span>
        </GlassBreadcrumb>
      );
  ...
  it("accepts and renders with custom props", () => {
    const { container } = render(
      <GlassBreadcrumb className="custom-class" data-testid="glassbreadcrumb">
        <span>Home</span>
      </GlassBreadcrumb>
    );

    const element =
      container.querySelector('[data-testid="glassbreadcrumb"]') ||
