/**
 * GlassBreadcrumb Component Tests
 *
 * Test Suite Coverage:
...
import { GlassBreadcrumb } from '@/components/navigation/GlassBreadcrumb';
...
describe('GlassBreadcrumb', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassBreadcrumb />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassBreadcrumb
        ...
        data-testid="glassbreadcrumb"
      />
    );

    const element = container.querySelector('[data-testid="glassbreadcrumb"]')
