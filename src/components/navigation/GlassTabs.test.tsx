...
import { GlassTabs } from '@/components/navigation/GlassTabs';
...
describe('GlassTabs', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassTabs />);
  ...
  describe('ARIA Attributes', () => {
    ...
    it('has accessible name', () => {
      render(<GlassTabs aria-label="Main navigation" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassTabs
        ...
        data-testid="glasstabs"
      />
    );

    const element = container.querySelector('[data-testid="glasstabs"]')
