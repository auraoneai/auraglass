...
describe('GlassResponsiveNav', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassResponsiveNav />);
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glassresponsivenav"]')
