'use client';
/**
 * EnhancedGlassTabs Component Tests
 *
 * Test Suite Coverage:
...
import { EnhancedGlassTabs } from '@/components/navigation/EnhancedGlassTabs';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('EnhancedGlassTabs', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<EnhancedGlassTabs />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <EnhancedGlassTabs
        ...
        data-testid="enhancedglasstabs"
      />
    );

    const element = container.querySelector('[data-testid="enhancedglasstabs"]')
