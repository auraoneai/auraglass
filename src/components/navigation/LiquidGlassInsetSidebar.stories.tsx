...
const meta: Meta<typeof LiquidGlassInsetSidebar> = {
  title: 'Navigation/Liquid Glass Inset Sidebar',
  component: LiquidGlassInsetSidebar,
  parameters: { layout: "fullscreen", previewSurface: "app" },
};
export default meta;
type Story = StoryObj<typeof LiquidGlassInsetSidebar>;

const insetSidebarStoryCss = `
...
export const Default: Story = {
  render: () => (
    <div className="liquid-inset-sidebar-story">
