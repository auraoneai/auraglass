...
describe('GlassMobileNav', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassMobileNav />);
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glassmobilenav"]')
