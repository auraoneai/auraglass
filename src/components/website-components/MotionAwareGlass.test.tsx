/**
 * MotionAwareGlass Component Tests
 *
 * Test Suite Coverage:
...
import { MotionAwareGlass } from '@/components/website-components/MotionAwareGlass';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('MotionAwareGlass', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<MotionAwareGlass />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<MotionAwareGlass aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <MotionAwareGlass
        ...
        data-testid="motionawareglass"
      />
    );

    const element = container.querySelector('[data-testid="motionawareglass"]')
