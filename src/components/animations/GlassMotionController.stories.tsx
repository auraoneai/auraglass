...
export const Default: Story = {
  args: {
    children: (
      <div className="glass-foundation-complete bg-transparent border-white/40 shadow-2xl glass-radius-2xl p-8 text-center glass-contrast-guard">
        ...
        <div className="mt-6 glass-inline-flex items-center gap-3 justify-center">
          <GlassAnimated animation={{ type: 'scaleIn', duration: 600, delay: 220 }}>
            <button className="glass-foundation-complete glass-hover bg-glass-frosted border-white/40 shadow-2xl glass-radius-xl px-4 py-2 transition-all glass-contrast-guard">
              Try It
            </button>
          </GlassAnimated>
  ...
  render: (args) => (
    <div className="flex flex-wrap gap-6">
      <GlassMotionController {...args}>
        <div className="glass-foundation-complete glass-glass-glass-backdrop-blur-md bg-transparent border-white/40 shadow-2xl glass-radius-2xl p-6 text-center min-w-40 glass-contrast-guard">
      ...
      <GlassMotionController {...args}>
        <div className="glass-foundation-complete glass-glass-glass-backdrop-blur-md bg-glass-frosted border-white/40 shadow-2xl glass-radius-2xl p-6 text-center min-w-40 glass-contrast-guard">
    ...
    <GlassMotionController enabled={true}>
      <GlassAnimationSequence staggerDelay={200}>
        <div className="grid grid-cols-3 gap-4">
          <GlassAnimated className="glass-foundation-complete glass-glass-glass-backdrop-blur-md bg-transparent border-white/40 shadow-2xl glass-radius-xl p-6 text-center hover:shadow-2xl transition-all glass-contrast-guard">
...
export const AnimationTimeline: Story = {
  render: (args) => (
    <GlassMotionController enabled={true}>
      ...
      >
        <div className="timeline-element glass-foundation-complete glass-glass-glass-backdrop-blur-md bg-transparent border-white/40 shadow-2xl glass-radius-2xl p-12 text-center glass-contrast-guard">
          ...
          <div className="mt-6 glass-inline-flex items-center gap-2 glass-code px-4 py-2 glass-radius-lg">
            <span className="w-2 h-2 glass-surface-green glass-radius-full animate-pulse glass-contrast-guard"></span>
        ...
        <div className="glass-auto-gap glass-auto-gap-2xl">
          <div className="flex justify-center">
            <button
              ...
              className="glass-foundation-complete glass-hover glass-glass-glass-backdrop-blur-md bg-transparent border-white/40 shadow-2xl px-8 py-4 glass-radius-xl transition-all glass-button hover:shadow-2xl hover:scale-110 hover:rotate-1 glass-focus glass-touch-target glass-contrast-guard"
            >
          ...
          <GlassAnimationSequence staggerDelay={isPlaying ? 200 : 0}>
            <div className="grid grid-cols-4 gap-4">
              {['🔵', '🟢', '🟡', '🔴'].map((emoji, index) => (
                <GlassAnimated
                  key={index}
                  className="glass-foundation-complete glass-glass-glass-backdrop-blur-md bg-transparent border-white/40 shadow-2xl p-8 glass-radius-2xl text-center hover:shadow-2xl hover:scale-105 hover:-rotate-2 transition-all duration-300 glass-contrast-guard"
                >
