...
import { WidgetGlass } from '@/components/surfaces/WidgetGlass';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('WidgetGlass', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<WidgetGlass />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <WidgetGlass
        ...
        data-testid="widgetglass"
      />
    );

    const element = container.querySelector('[data-testid="widgetglass"]')
