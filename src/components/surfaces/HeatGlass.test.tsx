...
import { HeatGlass } from '@/components/surfaces/HeatGlass';
...
describe('HeatGlass', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<HeatGlass />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <HeatGlass
        ...
        data-testid="heatglass"
      />
    );

    const element = container.querySelector('[data-testid="heatglass"]')
