...
export interface GlassConnectionStatusProps
...
export const GlassConnectionStatus = forwardRef<
  HTMLDivElement,
  GlassConnectionStatusProps
>(
  (
    {
    ...
    const [status, setStatus] = useState<"online" | "offline" | "slow">(
      "online"
    );
    ...
    return (
      <OptimizedGlass
        ...
        {...props}
      >
        <div className='glass-relative glass-flex glass-items-center glass-gap-2'>
          {config.icon ? (
            <div className={config.textColor}>{config.icon}</div>
          ) : (
            <div className='glass-relative glass-flex glass-items-center glass-justify-center'>
              <div
                className={cn(
          ...
          {showQuality && effectiveType && (
            <span
              className={cn(
                sizeClasses[size].text,
                "glass-text-secondary uppercase"
              )}
            >
              {effectiveType}
            </span>
