...
import * as ComponentModule from "./GlassImageProcessingProvider";
import {
  CertificationCase,
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component-owned Storybook coverage for GlassImageProcessingProvider. This story renders the certified AuraGlass sample used by the full visual certification suite.",
      },
    },
  },
