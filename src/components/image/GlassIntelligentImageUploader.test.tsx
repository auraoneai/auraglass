...
describe('GlassIntelligentImageUploader', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassIntelligentImageUploader aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glassintelligentimageuploader"]')
