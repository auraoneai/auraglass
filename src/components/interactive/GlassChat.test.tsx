...
import { GlassChat } from '@/components/interactive/GlassChat';
...
describe('GlassChat', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassChat />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassChat
        ...
        data-testid="glasschat"
      />
    );

    const element = container.querySelector('[data-testid="glasschat"]')
