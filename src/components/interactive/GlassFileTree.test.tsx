...
import { GlassFileTree } from '@/components/interactive/GlassFileTree';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassFileTree', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassFileTree />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassFileTree
        ...
        data-testid="glassfiletree"
      />
    );

    const element = container.querySelector('[data-testid="glassfiletree"]')
