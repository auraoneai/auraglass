    ...
    examples: [
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="glass-px-4 glass-py-2 glass-surface-blue glass-text-primary glass-radius-md">{children || 'Button'}</button>,
    ...
    examples: [
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="glass-px-4 glass-py-2 glass-surface-green glass-text-primary glass-radius-md">{children || 'Primary'}</button>,
      ...
      },
      {
        ...
        category: 'buttons',
        component: ({ children }) => <button className="glass-px-4 glass-py-2 glass-surface-primary glass-text-primary glass-radius-md">{children || 'Secondary'}</button>,
