...
import { GlassCardLink } from '@/components/interactive/GlassCardLink';
...
describe('GlassCardLink', () => {
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glasscardlink"]')
