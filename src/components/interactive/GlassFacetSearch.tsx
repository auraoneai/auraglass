                        ...
                        {showSuggestions && (suggestions.length > 0 || recentSearches.length > 0) && (
                            ...
                            >
                                ...
                                {suggestions.length > 0 && (
                                    <div className="p-2">
                                        <div className="text-xs text-primary/70 px-2 py-1">Suggestions</div>
                                        {suggestions.map((suggestion, index) => (
                                            <button
                                                ...
                                                className="w-full text-left px-2 py-1 text-sm text-primary hover:glass-surface-subtle/10 glass-radius-md transition-colors"
                                            >
                                                {suggestion}
                                            </button>
                                        ))}
                                ...
                                {recentSearches.length > 0 && (
                                    <div className="p-2 border-t border-white/10">
                                        <div className="text-xs text-primary/70 px-2 py-1">Recent Searches</div>
                                        ...
                                        >
                                            <div className="flex items-start justify-between">
                                                <div className="flex-1">
                                                    ...
                                                    {result.description && (
                                                        <p className="text-sm text-primary/70 glass-mt-1">{result.description}</p>
                                                    )}
                                                    <div className="flex items-center gap-2 glass-mt-2">
                                                        {result.category && (
                                                            <span className="px-2 py-1 text-xs glass-surface-subtle/10 text-primary/80 glass-radius-md">
                                                                {result.category}
                                                            </span>
                                                        )}
                                                        {result.tags && result.tags.map((tag, tagIndex) => (
                                                            <span key={tagIndex} className="flex items-center gap-1 px-2 py-1 text-xs glass-surface-blue/20 glass-text-secondary glass-radius-md">
