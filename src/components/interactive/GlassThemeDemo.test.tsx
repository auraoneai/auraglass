...
describe('GlassThemeDemo', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassThemeDemo aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassThemeDemo
        ...
        data-testid="glassthemedemo"
      />
    );

    const element = container.querySelector('[data-testid="glassthemedemo"]')
