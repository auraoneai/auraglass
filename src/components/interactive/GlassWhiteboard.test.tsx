...
import { GlassWhiteboard } from '@/components/interactive/GlassWhiteboard';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassWhiteboard', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassWhiteboard />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassWhiteboard
        ...
        data-testid="glasswhiteboard"
      />
    );

    const element = container.querySelector('[data-testid="glasswhiteboard"]')
