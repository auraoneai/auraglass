...
import { GlassFileUpload } from '@/components/interactive/GlassFileUpload';
...
describe('GlassFileUpload', () => {
  ...
  describe('ARIA Attributes', () => {
    it('has proper form control role', () => {
      render(<GlassFileUpload id="test-input" />);
      const element = screen.getByTestId('glassfileupload') || document.querySelector('#test-input');
      expect(element).toBeInTheDocument();
    });

    it('supports aria-label', () => {
      render(<GlassFileUpload aria-label="Test input" />);
    ...
    it('supports aria-describedby for help text', () => {
      render(
        <>
          <GlassFileUpload aria-describedby="help-text" />
