...
import { GlassVoiceInput } from '@/components/interactive/GlassVoiceInput';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassVoiceInput', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassVoiceInput />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassVoiceInput
        ...
        data-testid="glassvoiceinput"
      />
    );

    const element = container.querySelector('[data-testid="glassvoiceinput"]')
