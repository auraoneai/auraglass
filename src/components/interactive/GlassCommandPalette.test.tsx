...
describe("GlassCommandPalette", () => {
  ...
  it("renders without crashing", () => {
    const { container } = render(<GlassCommandPalette open={true} />);
  ...
  describe("ARIA Attributes", () => {
    it("supports aria-label", () => {
      const { container } = render(
        <GlassCommandPalette open={true} aria-label="Test component" />
      );
  ...
  describe("Focus Management", () => {
    it("can receive focus", () => {
      render(<GlassCommandPalette open={true} />);
      const element =
  ...
  it("accepts and renders with custom props", () => {
    ...
    const element =
      container.querySelector('[data-testid="glasscommandpalette"]') ||
