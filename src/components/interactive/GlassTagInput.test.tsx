...
import { GlassTagInput } from '@/components/interactive/GlassTagInput';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassTagInput', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassTagInput />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassTagInput
        ...
        data-testid="glasstaginput"
      />
    );

    const element = container.querySelector('[data-testid="glasstaginput"]')
