/**
 * GlassFileExplorer Component Tests
 *
 * Test Suite Coverage:
...
import { GlassFileExplorer } from '@/components/interactive/GlassFileExplorer';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassFileExplorer', () => {
  /**
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassFileExplorer
        ...
        data-testid="glassfileexplorer"
      />
    );

    const element = container.querySelector('[data-testid="glassfileexplorer"]')
