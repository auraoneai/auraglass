...
export const GlassThemeDemo = forwardRef<HTMLDivElement, GlassThemeDemoProps>(
  (
    ...
    const categoryExamples = {
      inputs: (
        <div className='glass-grid glass-grid-cols-1 md:glass-grid-cols-2 lg:glass-grid-cols-3 glass-gap-6 glass-mt-4'>
          <Card
            className={cn(
          ...
          >
            <Typography variant="h2" className='glass-mb-4 glass-font-semibold'>
              Button
            </Typography>
            <Box
            ...
            {showCode && (
              <pre className='glass-surface-dark/10 glass-radius-md glass-p-3 glass-font-mono glass-text-sm glass-overflow-auto glass-mt-4'>
...
<Switch label="Switch Option" />`}
          ...
          >
            ...
            <Typography
              ...
              variant="p"
              className='glass-text-secondary glass-text-xs glass-mt-1'
            >
              Adjust theme intensity for preview components.
            </Typography>
            {showCode && (
              <pre className='glass-surface-dark/10 glass-radius-md glass-p-3 glass-font-mono glass-text-sm glass-overflow-auto glass-mt-4'>{`<Slider defaultValue={50} aria-label="Slider" />`}</pre>
            )}
          </Card>
        </div>
      ),
...
<Avatar alt="User" />`}
    ...
    return (
      ...
      >
        ...
        {showPerformanceMetrics && (
          <section className='glass-mt-6'>
            ...
            <Card>
              <Box style={{ padding: "16px" }}>
                <Typography>
                  Theme performance metrics and optimization data
                </Typography>
              </Box>
            </Card>
          </section>
        ...
        {/* Footer */}
        {footer && (
          <Box style={{ marginTop: "auto", paddingTop: "8px" }}>{footer}</Box>
        )}
      </OptimizedGlass>
    );
  }
