...
describe("GlassStepper", () => {
  ...
  describe("ARIA Attributes", () => {
    it("has proper form control role", () => {
      render(<GlassStepper id="test-input" data-testid="glassstepper" />);
      const element = screen.getByTestId("glassstepper");
  ...
  it("accepts and renders with custom props", () => {
    const { container } = render(
      <GlassStepper className="custom-class" data-testid="glassstepper" />
    );

    const element =
      container.querySelector('[data-testid="glassstepper"]') ||
