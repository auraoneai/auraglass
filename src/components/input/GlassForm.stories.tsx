        ...
        <GlassFormField
          ...
          render={({ field }) => (
            <GlassFormItem>
              ...
              <GlassFormControl>
                <textarea
                  className="w-full px-3 py-2 glass-surface-subtle/10 border border-white/20 glass-radius-lg backdrop-blur-md text-primary placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/30"
                  rows={3}
