...
describe("GlassCheckboxGroup", () => {
  ...
  describe("ARIA Attributes", () => {
    it("has proper form control role", () => {
      render(
        <GlassCheckboxGroup id="test-input" data-testid="glasscheckboxgroup" />
      );
      const element = screen.getByTestId("glasscheckboxgroup");
  ...
  it("accepts and renders with custom props", () => {
    ...
    const element =
      container.querySelector('[data-testid="glasscheckboxgroup"]') ||
