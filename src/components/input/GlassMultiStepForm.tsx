            ...
            <Motion preset="fadeIn" className="w-full max-w-4xl mx-auto">
                <GlassCard className={cn('overflow-hidden', className)} {...props}>
                    ...
                    <CardHeader className="pb-6">
                        {title && (
                            <CardTitle className="text-primary text-2xl font-semibold text-center">
                                {title}
                            </CardTitle>
                        )}

                        {description && (
                            <p className="text-primary/70 text-center glass-mt-2">{description}</p>
                        )}
                        ...
                        {showProgress && (
                            <div className="mt-6" role="group" aria-label="Form progress">
                                <div className="flex justify-between items-center mb-2">
                                    <span className="text-sm text-primary/60" aria-live="polite">
                                ...
                                <div
                                    ...
                                    className="w-full glass-surface-subtle/10 glass-radius-full h-2 overflow-hidden"
                                >
                                    <Motion
                                        preset="slideRight"
                                        className="h-full glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-full"
                                        style={{ width: `${getProgressPercentage()}%` }}
                                    />
                                </div>

                                {/* Step Indicators */}
                                <nav aria-label="Form steps" className="flex justify-between glass-mt-4">
                                            ...
                                            >
                                                <div className={cn(
                                                    ...
                                                    {isCompleted && isValid ? (
                                                        ...
                                                        <span className="w-5 h-5" aria-hidden="true">{step.icon}</span>
                                                    ) : (
                                                ...
                                                <div className="text-center glass-mt-2">
                                                    ...
                                                    {step.description && (
                                                        <p className="text-xs text-primary/50 glass-mt-1 max-w-20 truncate">
                                                            {step.description}
                                                        </p>
                                                    )}
                                                </div>
                    ...
                    <CardContent className="pt-0">
                                        ...
                                        {isActive && (
                                            <div>
                                                ...
                                                {validationErrors[index] && (
                                                    <div role="alert" aria-live="assertive" className="glass-mt-4 p-3 glass-surface-red/20 border border-red/30 glass-radius-lg">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    {currentStep < steps.length - 1 ? (
                                        ...
                                        <GlassButton
                                            ...
                                            disabled={loading || isSubmitting}
                                            className="flex items-center gap-2 glass-min-w-24"
                                        >
                                            {isSubmitting ? (
                                                <>
                        ...
                        {/* Summary */}
                        {showSummary && (
                            <div className="mt-6 p-4 glass-surface-subtle/5 glass-radius-lg">
                                <h4 className="text-sm font-medium text-primary mb-3">Form Summary</h4>
                                <div className="gap-2">
                                    {steps.map((step, index) => {
                                        const isCompleted = isStepCompleted(index);
