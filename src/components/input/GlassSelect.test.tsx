...
import { GlassSelect } from '@/components/input/GlassSelect';
...
describe('GlassSelect', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassSelect />);
  ...
  describe('ARIA Attributes', () => {
    it('has proper form control role', () => {
      render(<GlassSelect id="test-input" />);
      const element = screen.getByTestId('glassselect') || document.querySelector('#test-input');
      expect(element).toBeInTheDocument();
    });

    it('supports aria-label', () => {
      render(<GlassSelect aria-label="Test input" />);
      const element = screen.getByRole('button', { name: /test input/i });
      expect(element).toBeInTheDocument();
    });
    ...
    it('supports aria-describedby for help text', () => {
      render(
        <>
          <GlassSelect aria-describedby="help-text" />
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassSelect
        ...
        data-testid="glassselect"
      />
    );

    const element = container.querySelector('[data-testid="glassselect"]')
