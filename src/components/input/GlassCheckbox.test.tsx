...
import { GlassCheckbox } from '@/components/input/GlassCheckbox';
...
describe('GlassCheckbox', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassCheckbox />);
  ...
  describe('ARIA Attributes', () => {
    it('has proper form control role', () => {
      render(<GlassCheckbox id="test-input" />);
      const element = screen.getByTestId('glasscheckbox') || document.querySelector('#test-input');
    ...
    it('supports aria-describedby for help text', () => {
      render(
        <>
          <GlassCheckbox aria-describedby="help-text" />
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassCheckbox
        ...
        data-testid="glasscheckbox"
      />
    );

    const element = container.querySelector('[data-testid="glasscheckbox"]')
