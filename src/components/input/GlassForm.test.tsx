...
describe('GlassForm', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassForm />);
  ...
  describe('ARIA Attributes', () => {
    it('has proper form control role', () => {
      render(<GlassForm id="test-input" />);
      const element = screen.getByTestId('glassform') || document.querySelector('#test-input');
      expect(element).toBeInTheDocument();
    });

    it('supports aria-label', () => {
      render(<GlassForm aria-label="Test input" />);
    ...
    it('supports aria-describedby for help text', () => {
      render(
        <>
          <GlassForm aria-describedby="help-text" />
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassForm
        ...
        data-testid="glassform"
      />
    );

    const element = container.querySelector('[data-testid="glassform"]')
