...
import { GlassSlider } from '@/components/input/GlassSlider';
...
describe('GlassSlider', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassSlider />);
  ...
  describe('ARIA Attributes', () => {
    it('has proper form control role', () => {
      render(<GlassSlider id="test-input" />);
      const element = screen.getByTestId('glassslider') || document.querySelector('#test-input');
    ...
    it('supports aria-describedby for help text', () => {
      render(
        <>
          <GlassSlider aria-describedby="help-text" />
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassSlider
        ...
        data-testid="glassslider"
      />
    );

    const element = container.querySelector('[data-testid="glassslider"]')
