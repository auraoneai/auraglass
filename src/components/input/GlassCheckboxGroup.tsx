...
export interface GlassCheckboxItemProps
...
export const GlassCheckboxItem = forwardRef<
  HTMLDivElement,
  GlassCheckboxItemProps
>(
  (
    {
      value,
...
export const GlassCheckboxGroup = forwardRef<
  HTMLDivElement,
              ...
              return (
                ...
                >
                  <div className="glass-flex glass-items-start glass-gap-3">
                    {option.icon && (
                      <div className="glass-flex-shrink-0 glass-mt-0-5">
                        {option.icon}
                      </div>
                    )}
