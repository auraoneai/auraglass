...
describe('GlassDataChart', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassDataChart aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassDataChart
        ...
        data-testid="glassdatachart"
      />
    );

    const element = container.querySelector('[data-testid="glassdatachart"]')
