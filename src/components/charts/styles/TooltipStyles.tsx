...
export const TooltipHeader: React.FC<TooltipHeaderProps> = ({ $theme = 'glass', $size = 'medium', className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  return (
    <div
...
export const TooltipBody: React.FC<TooltipBodyProps> = ({ $size = 'medium', className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  return (
    <div
...
export const TooltipItem: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, ...props }) => (
...
export const TooltipLabel: React.FC<TooltipLabelProps> = ({ $theme = 'glass', $size = 'medium', className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  return (
    <span
...
export const TooltipValue: React.FC<TooltipValueProps> = ({ $theme = 'glass', $size = 'medium', $color, className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  return (
    <span
...
export const TooltipSeparator: React.FC<TooltipSeparatorProps> = ({ $theme = 'glass', $size = 'medium', className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  const background =
    $theme === 'glass'
...
export const TooltipFooter: React.FC<TooltipFooterProps> = ({ $theme = 'glass', $size = 'medium', className, style, ...props }) => {
  const multiplier = getSizeMultiplier($size);
  return (
    <div
