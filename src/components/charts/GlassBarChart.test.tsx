...
describe('GlassBarChart', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassBarChart />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassBarChart aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassBarChart
        ...
        data-testid="glassbarchart"
      />
    );

    const element = container.querySelector('[data-testid="glassbarchart"]')
