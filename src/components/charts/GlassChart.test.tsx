...
describe("GlassChart", () => {
  ...
  it("renders without crashing", () => {
    const { container } = render(<GlassChart type="bar" data={mockData} />);
  ...
  describe("Reduced Motion Support", () => {
    it("respects prefers-reduced-motion", () => {
      ...
      const { container } = render(<GlassChart />);
  ...
  it("accepts and renders with custom props", () => {
    const { container } = render(
      <GlassChart
        ...
        data-testid="glasschart"
      />
    );

    const element =
      container.querySelector('[data-testid="glasschart"]') ||
