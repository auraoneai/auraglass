  ...
  ({
    ...
    const LayerSelector = () => (
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-primary/80">Neural Layers</h4>
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    <h5 className="text-sm font-medium text-primary/90">{layer.name}</h5>
                    <span className={`
                  ...
                  <p className="text-xs text-primary/60 mb-2">{layer.description}</p>
    ...
    const SettingsPanel = () => (
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-primary/80">Dream Settings</h4>
        ...
        <div className="flex items-center space-x-4">
          <label className="flex items-center space-x-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-primary/80">Enable Tiling</span>
          </label>
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 glass-radius border-white/30"
            />
            <span className="text-sm text-primary/80">Animate Result</span>
          </label>
        </div>
      </div>
    )
      ...
      >
        ...
        {showPreview && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            {/* DeepDream result */}
            <div className="space-y-2">
              <h4 className="text-sm font-medium text-primary/80">DeepDream</h4>
              <div className="relative aspect-video glass-surface-subtle/5 border border-white/20 glass-radius-lg overflow-hidden">
                <canvas
                  ref={dreamCanvasRef}
                  width={canvasWidth}
        ...
        {isGenerating && (
          ...
          `}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-primary/80">Generating Deep Dream...</span>
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          <div className="flex items-center space-x-4">
            ...
            <motion.button
              className="px-4 py-2 border border-white/30 hover:border-white/50 text-primary/80 glass-radius-lg text-sm transition-colors disabled:opacity-50"
              whileHover={shouldAnimate ? { scale: 1.02 } : {}}
              whileTap={shouldAnimate ? { scale: 0.98 } : {}}
