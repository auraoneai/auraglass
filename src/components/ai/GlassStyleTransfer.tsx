  ...
  ({
    ...
    const StyleLibrary = () => (
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-primary/80">Style Library</h4>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {styleModels.map((style) => (
            ...
            >
              <div className="aspect-square glass-gradient-primary glass-gradient-primary glass-gradient-primary glass-radius-lg mb-2 overflow-hidden">
                <div className={`
    ...
    const AdvancedControls = () => (
      <div className="space-y-4">
        <h4 className="text-sm font-medium text-primary/80">Advanced Controls</h4>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full h-2 glass-surface-subtle/20 glass-radius-lg appearance-none cursor-pointer slider"
            />
          </div>
        ...
        <div className="flex items-center space-x-6">
          <label className="flex items-center space-x-2 cursor-pointer">
            ...
            />
            <span className="text-sm text-primary/80">Preserve Colors</span>
          </label>
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              ...
              className="w-4 h-4 glass-radius border-white/30"
            />
            <span className="text-sm text-primary/80">Enhance Details</span>
          </label>
        </div>
      </div>
    )
    ...
    return (
      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Source image */}
          <div className="space-y-4">
            <h4 className="text-sm font-medium text-primary/80">Source Image</h4>
            
            <div 
              className="relative aspect-square glass-surface-subtle/5 border-2 border-dashed border-white/30 glass-radius-lg overflow-hidden cursor-pointer hover:border-white/50 transition-colors"
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h4 className="text-sm font-medium text-primary/80">Style Preview</h4>
            ...
            <div className="relative aspect-square glass-surface-subtle/5 border border-white/20 glass-radius-lg overflow-hidden">
              {previewImage ? (
                <img 
                  src={previewImage} 
                  alt="Styled preview" 
              ...
              {isProcessing && (
                <div className="absolute inset-0 glass-surface-dark/50 flex items-center justify-center">
                  <div className="text-center text-primary">
                    <div className="w-8 h-8 border-2 border-white border-t-transparent glass-radius-full animate-spin mx-auto mb-2" />
        ...
        <div className="flex items-center justify-between pt-4 border-t border-white/10">
          <div className="flex items-center space-x-4">
            <motion.button
              className="px-4 py-2 glass-surface-blue hover:glass-surface-blue text-primary glass-radius-lg text-sm font-medium transition-colors"
              whileHover={shouldAnimate ? { scale: 1.02 } : {}}
              whileTap={shouldAnimate ? { scale: 0.98 } : {}}
        ...
        {isProcessing && showProgressIndicator && (
          ...
          `}>
            <div className="flex items-center justify-between mb-2">
              <span className="text-sm text-primary/80">Processing Style Transfer</span>
