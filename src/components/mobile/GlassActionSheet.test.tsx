...
describe('GlassActionSheet', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassActionSheet />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassActionSheet aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glassactionsheet"]')
