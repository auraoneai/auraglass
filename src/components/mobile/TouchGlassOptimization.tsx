        ...
        {ripples.map((ripple) => (
          <motion.div
            ...
            transition={
              prefersReducedMotion
                ? { duration: 0 }
                : { duration: rippleDuration / 1000, ease: "easeOut" }
            }
          />
        ))}
      </AnimatePresence>
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            {/* Handle */}
            <div className="glass-flex glass-justify-center glass-py-3">
              <div
                className={cn(
                  "glass-w-12 glass-h-1.5 glass-surface-secondary glass-radius-full"
                )}
              />
            </div>
