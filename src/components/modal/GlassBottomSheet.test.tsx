'use client';
/**
 * GlassBottomSheet Component Tests
 *
 * Test Suite Coverage:
...
import { GlassBottomSheet } from '@/components/modal/GlassBottomSheet';
...
describe('GlassBottomSheet', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassBottomSheet />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassBottomSheet aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassBottomSheet
        ...
        data-testid="glassbottomsheet"
      />
    );

    const element = container.querySelector('[data-testid="glassbottomsheet"]')
