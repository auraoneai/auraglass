...
const meta: Meta<typeof LiquidGlassAdaptiveSheet> = {
  title: 'Surfaces/Modals/Liquid Glass Adaptive Sheet',
  component: LiquidGlassAdaptiveSheet,
  parameters: { layout: "fullscreen", previewSurface: "app" },
};
export default meta;
type Story = StoryObj<typeof LiquidGlassAdaptiveSheet>;

const adaptiveSheetStoryCss = `
...
export const Bottom: Story = {
  render: () => (
    <div className="liquid-adaptive-sheet-story">
      ...
      <div className="liquid-adaptive-sheet-card">
        ...
        <div className="liquid-adaptive-sheet-lane" aria-hidden="true">
          ...
          <div className="liquid-adaptive-sheet-row" style={{ width: "82%" }} />
          <div className="liquid-adaptive-sheet-row" style={{ width: "68%" }} />
        </div>
      </div>
      <LiquidGlassAdaptiveSheet open title="Export options" height={320} presentationMode="parallel">
        <div style={{ display: "grid", gap: 12 }}>
          <p className="liquid-adaptive-sheet-copy" style={{ margin: 0 }}>Choose delivery settings for the selected media batch.</p>
