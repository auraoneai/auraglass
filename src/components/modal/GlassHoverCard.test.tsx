'use client';
/**
 * GlassHoverCard Component Tests
 *
 * Test Suite Coverage:
...
import { GlassHoverCard } from '@/components/modal/GlassHoverCard';
...
describe('GlassHoverCard', () => {
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glasshovercard"]')
