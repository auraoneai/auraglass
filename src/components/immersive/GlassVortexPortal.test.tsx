'use client';
/**
 * GlassVortexPortal Component Tests
 *
 * Test Suite Coverage:
...
import { GlassVortexPortal } from '@/components/immersive/GlassVortexPortal';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassVortexPortal', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassVortexPortal />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassVortexPortal
        ...
        data-testid="glassvortexportal"
      />
    );

    const element = container.querySelector('[data-testid="glassvortexportal"]')
