...
export interface GlassFluidSimulationProps
...
const DEFAULT_FLUID_COLOR: [number, number, number, number] = [
  100, 150, 255, 0.8,
];

export const GlassFluidSimulation = forwardRef<
  HTMLDivElement,
  GlassFluidSimulationProps
>(
  (
    {
      width = 800,
      ...
      (particles: FluidParticle[]) => {
        ...
        particles.forEach((particle: any) => {
          ...
          gradient.addColorStop(
            0,
            `rgba(${particle.color[0]}, ${particle.color[1]}, ${particle.color[2]}, ${particle.color[3]})`
          );
          gradient.addColorStop(
            1,
