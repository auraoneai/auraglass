/**
 * GlassFluidSimulation Component Tests
 *
 * Test Suite Coverage:
...
import { GlassFluidSimulation } from '@/components/immersive/GlassFluidSimulation';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassFluidSimulation', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassFluidSimulation />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassFluidSimulation
        ...
        data-testid="glassfluidsimulation"
      />
    );

    const element = container.querySelector('[data-testid="glassfluidsimulation"]')
