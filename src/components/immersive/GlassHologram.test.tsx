...
import { GlassHologram } from '@/components/immersive/GlassHologram';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassHologram', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassHologram />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassHologram
        ...
        data-testid="glasshologram"
      />
    );

    const element = container.querySelector('[data-testid="glasshologram"]')
