...
import { GlassParticleField } from '@/components/immersive/GlassParticleField';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassParticleField', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassParticleField />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassParticleField
        ...
        data-testid="glassparticlefield"
      />
    );

    const element = container.querySelector('[data-testid="glassparticlefield"]')
