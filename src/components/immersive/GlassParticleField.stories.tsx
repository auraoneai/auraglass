...
import * as ComponentModule from "./GlassParticleField";
import {
  CertificationCase,
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component-owned Storybook coverage for GlassParticleField. This story renders the certified AuraGlass sample used by the full visual certification suite.",
      },
    },
  },
