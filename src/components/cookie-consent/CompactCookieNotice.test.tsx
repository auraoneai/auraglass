/**
 * CompactCookieNotice Component Tests
 *
 * Test Suite Coverage:
...
describe('CompactCookieNotice', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<CompactCookieNotice />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<CompactCookieNotice aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <CompactCookieNotice
        ...
        data-testid="compactcookienotice"
      />
    );

    const element = container.querySelector('[data-testid="compactcookienotice"]')
