...
describe('ParticleBackground', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<ParticleBackground aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <ParticleBackground
        ...
        data-testid="particlebackground"
      />
    );

    const element = container.querySelector('[data-testid="particlebackground"]')
