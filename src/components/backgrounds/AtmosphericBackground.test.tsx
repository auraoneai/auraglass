"use client";
/**
 * AtmosphericBackground Component Tests
 *
 * Test Suite Coverage:
  ...
  describe("ARIA Attributes", () => {
    it("supports aria-label", () => {
      const { container } = render(
        <AtmosphericBackground aria-label="Test component" />
      );
      const element = container.querySelector('[aria-label="Test component"]');
      expect(element).toBeInTheDocument();
    });

    it("does not hide slotted content from assistive technology", () => {
      render(
        <AtmosphericBackground>
          <button type="button">Readable action</button>
        </AtmosphericBackground>
      );
  ...
  it("accepts and renders with custom props", () => {
    const { container } = render(
      <AtmosphericBackground
        ...
        data-testid="atmosphericbackground"
      />
    );

    const element =
      container.querySelector('[data-testid="atmosphericbackground"]') ||
