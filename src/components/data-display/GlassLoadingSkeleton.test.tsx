...
import { GlassLoadingSkeleton } from '@/components/data-display/GlassLoadingSkeleton';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassLoadingSkeleton', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassLoadingSkeleton />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassLoadingSkeleton aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassLoadingSkeleton
        ...
        data-testid="glassloadingskeleton"
      />
    );
