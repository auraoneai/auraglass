...
import { GlassTreeView } from '@/components/data-display/GlassTreeView';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassTreeView', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassTreeView />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassTreeView aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassTreeView
        ...
        data-testid="glasstreeview"
      />
    );

    const element = container.querySelector('[data-testid="glasstreeview"]')
