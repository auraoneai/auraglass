...
import { GlassNotificationCenter } from '@/components/data-display/GlassNotificationCenter';
...
describe('GlassNotificationCenter', () => {
  ...
  it('accepts and renders with custom props', () => {
    ...
    const element = container.querySelector('[data-testid="glassnotificationcenter"]')
