...
import { GlassAlert } from '@/components/data-display/GlassAlert';
...
describe('GlassAlert', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassAlert />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassAlert aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassAlert
        ...
        data-testid="glassalert"
      />
    );

    const element = container.querySelector('[data-testid="glassalert"]')
