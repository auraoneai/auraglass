...
const meta: Meta<typeof LiquidGlassBadgeCluster> = {
  title: 'Data + Visualization/Liquid Glass Badge Cluster',
  component: LiquidGlassBadgeCluster,
  parameters: { layout: "fullscreen", previewSurface: "app" },
};
export default meta;
type Story = StoryObj<typeof LiquidGlassBadgeCluster>;

const badgeClusterStoryCss = `
...
export const Collapsed: Story = {
  render: () => (
    <div className="liquid-badge-cluster-story">
      <style>{badgeClusterStoryCss}</style>
      <div className="liquid-badge-cluster-panel">
        <div>
          <h2 style={{ margin: 0, fontSize: 20 }}>Review filters</h2>
          <p style={{ margin: "6px 0 0" }}>Collapsed badges retain context and reveal overflow intentionally.</p>
        </div>
        <LiquidGlassBadgeCluster
          items={[
            { id: "a", label: "Adaptive", selected: true },
            { id: "b", label: "Grouped" },
