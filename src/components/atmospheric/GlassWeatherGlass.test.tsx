...
import { GlassWeatherGlass } from '@/components/atmospheric/GlassWeatherGlass';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassWeatherGlass', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassWeatherGlass />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassWeatherGlass
        ...
        data-testid="glassweatherglass"
      />
    );

    const element = container.querySelector('[data-testid="glassweatherglass"]')
