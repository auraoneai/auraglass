...
describe('GlassScrollArea', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassScrollArea aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassScrollArea
        ...
        data-testid="glassscrollarea"
      />
    );

    const element = container.querySelector('[data-testid="glassscrollarea"]')
