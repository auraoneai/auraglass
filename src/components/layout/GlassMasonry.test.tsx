...
describe('GlassMasonry', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassMasonry />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassMasonry aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassMasonry
        ...
        data-testid="glassmasonry"
      />
    );

    const element = container.querySelector('[data-testid="glassmasonry"]')
