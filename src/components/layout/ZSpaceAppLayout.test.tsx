...
describe('ZSpaceAppLayout', () => {
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<ZSpaceAppLayout aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <ZSpaceAppLayout
        ...
        data-testid="zspaceapplayout"
      />
    );

    const element = container.querySelector('[data-testid="zspaceapplayout"]')
