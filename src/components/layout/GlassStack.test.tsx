...
import { GlassStack } from '@/components/layout/GlassStack';
...
describe('GlassStack', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassStack />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassStack aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassStack
        ...
        data-testid="glassstack"
      />
    );

    const element = container.querySelector('[data-testid="glassstack"]')
