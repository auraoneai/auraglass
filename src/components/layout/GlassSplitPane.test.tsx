'use client';
/**
 * GlassSplitPane Component Tests
 *
 * Test Suite Coverage:
...
import { GlassSplitPane } from '@/components/layout/GlassSplitPane';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassSplitPane', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassSplitPane />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassSplitPane aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassSplitPane
        ...
        data-testid="glasssplitpane"
      />
    );

    const element = container.querySelector('[data-testid="glasssplitpane"]')
