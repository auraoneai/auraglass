...
import { GlassFlex } from '@/components/layout/GlassFlex';
...
describe('GlassFlex', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassFlex />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassFlex aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassFlex
        ...
        data-testid="glassflex"
      />
    );

    const element = container.querySelector('[data-testid="glassflex"]')
