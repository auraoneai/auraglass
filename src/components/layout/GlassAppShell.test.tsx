...
describe('GlassAppShell', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlassAppShell />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassAppShell aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassAppShell
        ...
        data-testid="glassappshell"
      />
    );

    const element = container.querySelector('[data-testid="glassappshell"]')
