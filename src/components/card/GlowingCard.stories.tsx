...
import * as ComponentModule from "./GlowingCard";
import {
  CertificationCase,
  type MissingComponentName,
} from "../../stories/GlassMissingInventoryCertification.stories";

const componentName = "GlowingCard" satisfies MissingComponentName;
const Component =
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component-owned Storybook coverage for GlowingCard. This story renders the certified AuraGlass sample used by the full visual certification suite.",
      },
    },
  },
