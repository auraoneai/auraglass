...
describe('GlowingCard', () => {
  ...
  it('renders without crashing', () => {
    const { container } = render(<GlowingCard />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlowingCard aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlowingCard
        ...
        data-testid="glowingcard"
      />
    );

    const element = container.querySelector('[data-testid="glowingcard"]')
