        ...
        {enableVersionControl && (
          <>
            <button
              onClick={onUndo}
              disabled={!canUndo}
              className='glass-p-2 glass-radius hover:glass-surface-subtle/10 disabled:glass-opacity-50 glass-text-primary glass-focus glass-touch-target glass-contrast-guard glass-focus glass-touch-target glass-contrast-guard'
              title="Undo"
    ...
    >
      <div className="glass-p-4">
        <div className='glass-flex glass-items-center glass-justify-between glass-mb-4'>
          <h2 className='glass-text-primary glass-font-semibold'>Properties Editor</h2>
            ...
            {onlineUsers.map((user: any) => (
              ...
              >
                ...
                <div className="glass-flex-1">
                  <div className='glass-text-sm glass-text-primary'>{user.name}</div>
...
function VersionControlPanel({
  ...
  return (
    ...
    >
      <div className='glass-flex glass-items-center glass-justify-between glass-mb-4'>
        <h3 className='glass-text-primary glass-font-semibold'>Version Control</h3>
        <button
          onClick={onClose}
          className='glass-contrast-guard glass-focus glass-touch-target hover:glass-text-primary glass-text-primary-opacity-70'
  ...
  return (
    <div className='glass-h-screen glass-flex glass-items-center glass-justify-center glass-surface-dark'>
      <div className='glass-text-center glass-space-y-4'>
        ...
        <div className='glass-text-primary-glass-opacity-60 glass-text-sm'>Please wait...</div>
      </div>
    </div>
  );
}
