    ...
    <div className="glass-grid glass-glass-grid-cols-1 md:glass-glass-grid-cols-2 lg:glass-glass-grid-cols-4 glass-gap-6">
      <div className="glass-surface-subtle/10 glass-glass-glass-backdrop-blur-lg glass-contrast-guard glass-radius-2xl glass-p-6 glass-contrast-guard">
        <div className="glass-flex glass-items-center glass-justify-between glass-mb-4">
          <h3 className="glass-text-xl glass-font-semibold glass-text-primary">Performance Mode</h3>
        ...
        <div className="glass-space-y-3">
          <div className="glass-flex glass-justify-between glass-text-primary/80">
            <span>Current Mode</span>
            <span className="glass-font-medium glass-capitalize">{performanceMode}</span>
          </div>
      ...
      <div className="glass-surface-subtle/10 glass-glass-glass-backdrop-blur-lg glass-contrast-guard glass-radius-2xl glass-p-6 glass-contrast-guard">
        <div className="glass-flex glass-items-center glass-justify-between glass-mb-4">
          <h3 className="glass-text-xl glass-font-semibold glass-text-primary">Battery Level</h3>
          <div className="glass-text-2xl">🔋</div>
        </div>
        <div className="glass-space-y-3">
          <div className="glass-flex glass-justify-between glass-text-primary/80">
            <span>Charge</span>
            <span className="glass-font-medium">{batteryLevel || 85}%</span>
          </div>
          <div className="glass-w-full glass-surface-subtle/20 glass-radius-full glass-h-2">
            <div
              className={`h-2 rounded-full transition-all duration-500 ${
      ...
      <div className="glass-surface-subtle/10 glass-glass-glass-backdrop-blur-lg glass-contrast-guard glass-radius-2xl glass-p-6 glass-contrast-guard">
        <div className="glass-flex glass-items-center glass-justify-between glass-mb-4">
          <h3 className="glass-text-xl glass-font-semibold glass-text-primary">CPU Load</h3>
          <div className="glass-text-2xl">⚡</div>
        </div>
        <div className="glass-space-y-3">
          <div className="glass-flex glass-justify-between glass-text-primary/80">
            <span>Usage</span>
            <span className="glass-font-medium">{cpuLoad.toFixed(1)}%</span>
          </div>
          <div className="glass-w-full glass-surface-subtle/20 glass-radius-full glass-h-2">
            <div
              className={`h-2 rounded-full transition-all duration-500 ${
      ...
      <div className="glass-surface-subtle/10 glass-glass-glass-backdrop-blur-lg glass-contrast-guard glass-radius-2xl glass-p-6 glass-contrast-guard">
        <div className="glass-flex glass-items-center glass-justify-between glass-mb-4">
          <h3 className="glass-text-xl glass-font-semibold glass-text-primary">GPU Acceleration</h3>
          <div className="glass-text-2xl">{gpuAcceleration ? '🚀' : '🐌'}</div>
        </div>
        <div className="glass-space-y-3">
          <div className="glass-flex glass-justify-between glass-text-primary/80">
            <span>Status</span>
            ...
            <div className="glass-grid glass-glass-grid-cols-1 md:glass-glass-grid-cols-2 lg:glass-glass-grid-cols-3 glass-gap-8">
              {[1, 2, 3, 4, 5, 6].map(index => (
                <LazyGlassLoading
                  key={index}
                  placeholder={
                    <div className="glass-h-48 glass-surface-subtle/5 glass-radius-2xl glass-flex glass-items-center glass-justify-center">
