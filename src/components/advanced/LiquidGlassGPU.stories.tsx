...
import * as ComponentModule from "./LiquidGlassGPU";
import {
  CertificationCase,
  type MissingComponentName,
} from "../../stories/GlassMissingInventoryCertification.stories";

const componentName = "LiquidGlassGPU" satisfies MissingComponentName;
const Component =
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component-owned Storybook coverage for LiquidGlassGPU. This story renders the certified AuraGlass sample used by the full visual certification suite.",
      },
    },
  },
