...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "Component-owned Storybook coverage for GlassProgressiveEnhancement. This story renders the certified AuraGlass sample used by the full visual certification suite.",
      },
    },
  },
