'use client';
/**
 * GlassParticles Component Tests
 *
 * Test Suite Coverage:
...
import { GlassParticles } from '@/components/advanced/GlassParticles';

// Extend Jest matchers
expect.extend(toHaveNoViolations);

describe('GlassParticles', () => {
  /**
   * Smoke Test: Component renders without crashing
   */
  it('renders without crashing', () => {
    const { container } = render(<GlassParticles />);
  ...
  describe('ARIA Attributes', () => {
    it('supports aria-label', () => {
      const { container } = render(<GlassParticles aria-label="Test component" />);
  ...
  it('accepts and renders with custom props', () => {
    const { container } = render(
      <GlassParticles
        ...
        data-testid="glassparticles"
      />
    );

    const element = container.querySelector('[data-testid="glassparticles"]')
