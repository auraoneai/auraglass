...
function LiquidRipples({
  ...
  intensity,
  duration,
}: LiquidRipplesProps): JSX.Element {
  const prefersReducedMotion = useReducedMotion();
...
export const GlassLiquidContainer = React.forwardRef<
  HTMLDivElement,
  GlassLiquidContainerProps
>(
  (
    {
      children,
