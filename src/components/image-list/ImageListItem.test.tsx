...
describe("ImageListItem", () => {
  ...
  describe("ARIA Attributes", () => {
    it("supports aria-label", () => {
      const { container } = render(
        <ul role="list">
          <ImageListItem aria-label="Test component" />
        </ul>
      );
  ...
  describe("Focus Management", () => {
    ...
    it("shows visible focus indicator", () => {
      ...
      const element = container.querySelector('[tabindex="0"]') as HTMLElement;
      if (element) {
        element.focus();
  ...
  it("accepts and renders with custom props", () => {
    const { container } = render(
      <ul role="list">
        <ImageListItem className="custom-class" data-testid="imagelistitem" />
      </ul>
    );

    const element =
      container.querySelector('[data-testid="imagelistitem"]') ||
