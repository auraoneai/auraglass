...
```tsx
import { GlassReactions } from 'aura-glass';

export function GlassReactionsExample() {
  return (
    <GlassReactions aria-label="GlassReactions example">
      GlassReactions content
    </GlassReactions>
  );
}
```
