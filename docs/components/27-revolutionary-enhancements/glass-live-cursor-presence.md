...
```tsx
import { GlassLiveCursorPresence } from 'aura-glass';

export function GlassLiveCursorPresenceExample() {
  return (
    <GlassLiveCursorPresence aria-label="GlassLiveCursorPresence example">
      GlassLiveCursorPresence content
    </GlassLiveCursorPresence>
  );
}
```
