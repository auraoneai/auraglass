...
```tsx
import { GlassOrientationEffects } from 'aura-glass';

export function GlassOrientationEffectsExample() {
  return (
    <GlassOrientationEffects aria-label="GlassOrientationEffects example">
      GlassOrientationEffects content
    </GlassOrientationEffects>
  );
}
```
