...
```tsx
import { GlassContextAware } from 'aura-glass';

export function GlassContextAwareExample() {
  return (
    <GlassContextAware aria-label="GlassContextAware example">
      GlassContextAware content
    </GlassContextAware>
  );
}
```
