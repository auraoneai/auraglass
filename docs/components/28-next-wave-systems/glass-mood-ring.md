...
```tsx
import { GlassMoodRing } from 'aura-glass';

export function GlassMoodRingExample() {
  return (
    <GlassMoodRing aria-label="GlassMoodRing example">
      GlassMoodRing content
    </GlassMoodRing>
  );
}
```
