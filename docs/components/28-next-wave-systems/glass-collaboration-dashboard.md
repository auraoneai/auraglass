...
- Category: misc
- Direct Storybook story: `src/components/collaboration/GlassCollaborationDashboard.stories.tsx`
...
```tsx
import { GlassCollaborationDashboard } from 'aura-glass';

export function GlassCollaborationDashboardExample() {
  return (
    <GlassCollaborationDashboard aria-label="GlassCollaborationDashboard example">
      GlassCollaborationDashboard content
    </GlassCollaborationDashboard>
  );
}
```
