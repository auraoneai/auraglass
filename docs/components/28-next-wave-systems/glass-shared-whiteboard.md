...
```tsx
import { GlassSharedWhiteboard } from 'aura-glass';

export function GlassSharedWhiteboardExample() {
  return (
    <GlassSharedWhiteboard aria-label="GlassSharedWhiteboard example">
      GlassSharedWhiteboard content
    </GlassSharedWhiteboard>
  );
}
```
