...
- Category: misc
- Direct Storybook story: `src/components/social/GlassSocialFeed.stories.tsx`
...
```tsx
import { GlassSocialFeed } from 'aura-glass';

export function GlassSocialFeedExample() {
  return (
    <GlassSocialFeed aria-label="GlassSocialFeed example">
      GlassSocialFeed content
    </GlassSocialFeed>
  );
}
```
