...
```tsx
import { GlassNebulaClouds } from 'aura-glass';

export function GlassNebulaCloudsExample() {
  return (
    <GlassNebulaClouds aria-label="GlassNebulaClouds example">
      GlassNebulaClouds content
    </GlassNebulaClouds>
  );
}
```
