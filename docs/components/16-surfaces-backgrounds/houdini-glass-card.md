...
- Category: misc
- Direct Storybook story: `src/components/houdini/HoudiniGlassCard.stories.tsx`
...
```tsx
import { HoudiniGlassCard } from 'aura-glass';

export function HoudiniGlassCardExample() {
  return (
    <HoudiniGlassCard aria-label="HoudiniGlassCard example">
      HoudiniGlassCard content
    </HoudiniGlassCard>
  );
}
```
