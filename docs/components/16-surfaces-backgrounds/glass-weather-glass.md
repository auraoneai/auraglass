...
```tsx
import { GlassWeatherGlass } from 'aura-glass';

export function GlassWeatherGlassExample() {
  return (
    <GlassWeatherGlass aria-label="GlassWeatherGlass example">
      GlassWeatherGlass content
    </GlassWeatherGlass>
  );
}
```
