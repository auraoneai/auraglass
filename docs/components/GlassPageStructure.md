...
- Category: misc
- Direct Storybook story: `src/components/cms/GlassPageStructure.stories.tsx`
...
```tsx
import { GlassPageStructure } from 'aura-glass';

export function GlassPageStructureExample() {
  return (
    <GlassPageStructure aria-label="GlassPageStructure example">
      GlassPageStructure content
    </GlassPageStructure>
  );
}
```
