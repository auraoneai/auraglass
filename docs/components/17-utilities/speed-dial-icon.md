...
```tsx
import { SpeedDialIcon } from 'aura-glass';

export function SpeedDialIconExample() {
  return (
    <SpeedDialIcon aria-label="SpeedDialIcon example">
      SpeedDialIcon content
    </SpeedDialIcon>
  );
}
```
