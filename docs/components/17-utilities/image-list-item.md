...
```tsx
import { ImageListItem } from 'aura-glass';

export function ImageListItemExample() {
  return (
    <ImageListItem aria-label="ImageListItem example">
