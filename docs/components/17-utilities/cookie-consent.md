...
```tsx
import { CookieConsent } from 'aura-glass';

export function CookieConsentExample() {
  return (
    <CookieConsent aria-label="CookieConsent example">
