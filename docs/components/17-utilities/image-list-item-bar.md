...
```tsx
import { ImageListItemBar } from 'aura-glass';

export function ImageListItemBarExample() {
  return (
    <ImageListItemBar aria-label="ImageListItemBar example">
      ImageListItemBar content
    </ImageListItemBar>
  );
}
```
