...
```tsx
import { TreeItem } from 'aura-glass';

export function TreeItemExample() {
  return (
    <TreeItem aria-label="TreeItem example">
      TreeItem content
    </TreeItem>
  );
}
