...
```tsx
import { ClearIcon } from 'aura-glass';

export function ClearIconExample() {
  return (
    <ClearIcon aria-label="ClearIcon example">
      ClearIcon content
    </ClearIcon>
  );
}
