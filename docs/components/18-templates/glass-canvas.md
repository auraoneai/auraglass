...
```tsx
import { GlassCanvas } from 'aura-glass';

export function GlassCanvasExample() {
  return (
    <GlassCanvas aria-label="GlassCanvas example">
      GlassCanvas content
    </GlassCanvas>
  );
}
