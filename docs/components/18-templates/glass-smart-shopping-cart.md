...
export function GlassSmartShoppingCartExample() {
  return (
    <GlassSmartShoppingCart aria-label="GlassSmartShoppingCart example">
      GlassSmartShoppingCart content
    </GlassSmartShoppingCart>
  );
}
```
