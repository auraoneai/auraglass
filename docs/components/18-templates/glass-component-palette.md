...
```tsx
import { GlassComponentPalette } from 'aura-glass';

export function GlassComponentPaletteExample() {
  return (
    <GlassComponentPalette aria-label="GlassComponentPalette example">
      GlassComponentPalette content
    </GlassComponentPalette>
  );
}
```
