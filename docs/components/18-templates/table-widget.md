...
```tsx
import { TableWidget } from 'aura-glass';

export function TableWidgetExample() {
  return (
    <TableWidget aria-label="TableWidget example">
      TableWidget content
    </TableWidget>
  );
}
