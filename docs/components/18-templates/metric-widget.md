...
```tsx
import { MetricWidget } from 'aura-glass';

export function MetricWidgetExample() {
  return (
    <MetricWidget aria-label="MetricWidget example">
      MetricWidget content
    </MetricWidget>
  );
}
```
