...
```tsx
import { GlassPageBuilder } from 'aura-glass';

export function GlassPageBuilderExample() {
  return (
    <GlassPageBuilder aria-label="GlassPageBuilder example">
      GlassPageBuilder content
    </GlassPageBuilder>
  );
}
```
