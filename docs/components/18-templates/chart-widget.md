...
```tsx
import { ChartWidget } from 'aura-glass';

export function ChartWidgetExample() {
  return (
    <ChartWidget aria-label="ChartWidget example">
      ChartWidget content
    </ChartWidget>
  );
}
