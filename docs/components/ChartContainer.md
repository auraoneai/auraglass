...
```tsx
import { ChartContainer } from 'aura-glass';

export function ChartContainerExample() {
  return (
    <ChartContainer aria-label="ChartContainer example">
