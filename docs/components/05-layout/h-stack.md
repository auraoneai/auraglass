...
```tsx
import { HStack } from 'aura-glass';

export function HStackExample() {
  return (
    <HStack aria-label="HStack example">
      HStack content
    </HStack>
  );
}
