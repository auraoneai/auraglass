...
```tsx
import { GlassOrbitalMenu } from 'aura-glass';

export function GlassOrbitalMenuExample() {
  return (
    <GlassOrbitalMenu aria-label="GlassOrbitalMenu example">
      GlassOrbitalMenu content
    </GlassOrbitalMenu>
  );
}
```
