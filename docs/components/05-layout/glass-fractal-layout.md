...
```tsx
import { GlassFractalLayout } from 'aura-glass';

export function GlassFractalLayoutExample() {
  return (
    <GlassFractalLayout aria-label="GlassFractalLayout example">
      GlassFractalLayout content
    </GlassFractalLayout>
  );
}
```
