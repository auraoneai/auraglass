...
```tsx
import { GlassTessellation } from 'aura-glass';

export function GlassTessellationExample() {
  return (
    <GlassTessellation aria-label="GlassTessellation example">
      GlassTessellation content
    </GlassTessellation>
  );
}
```
