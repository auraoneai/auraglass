...
- `src/components/layout/ZSpaceAppLayout.tsx`
...
export function ZSpaceAppLayoutExample() {
  return (
    <ZSpaceAppLayout aria-label="ZSpaceAppLayout example">
      ZSpaceAppLayout content
    </ZSpaceAppLayout>
  );
}
```
