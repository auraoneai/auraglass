...
```tsx
import { VStack } from 'aura-glass';

export function VStackExample() {
  return (
    <VStack aria-label="VStack example">
      VStack content
    </VStack>
  );
}
