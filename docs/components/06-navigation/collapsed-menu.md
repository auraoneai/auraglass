...
```tsx
import { CollapsedMenu } from 'aura-glass';

export function CollapsedMenuExample() {
  return (
    <CollapsedMenu aria-label="CollapsedMenu example">
      CollapsedMenu content
    </CollapsedMenu>
  );
}
```
