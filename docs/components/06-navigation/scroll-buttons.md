...
```tsx
import { ScrollButtons } from 'aura-glass';

export function ScrollButtonsExample() {
  return (
    <ScrollButtons aria-label="ScrollButtons example">
