...
```tsx
import { GlassTabBar } from 'aura-glass';

export function GlassTabBarExample() {
  return (
    <GlassTabBar aria-label="GlassTabBar example">
      GlassTabBar content
    </GlassTabBar>
  );
}
