...
- `src/components/navigation/GlassTabItem.tsx`
...
export function GlassTabItemExample() {
  return (
    <GlassTabItem aria-label="GlassTabItem example">
      GlassTabItem content
    </GlassTabItem>
  );
}
```
