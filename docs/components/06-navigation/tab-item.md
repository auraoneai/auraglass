...
```tsx
import { TabItem } from 'aura-glass';

export function TabItemExample() {
  return (
    <TabItem aria-label="TabItem example">
      TabItem content
    </TabItem>
  );
}
