...
```tsx
import { HeaderUserMenu } from 'aura-glass';

export function HeaderUserMenuExample() {
  return (
    <HeaderUserMenu aria-label="HeaderUserMenu example">
