...
- Category: misc
- Direct Storybook story: `src/components/dashboard/DimensionalDashboardContainer.stories.tsx`
...
- `src/components/dashboard/DimensionalDashboardContainer.tsx`
...
export function DimensionalDashboardContainerExample() {
  return (
    <DimensionalDashboardContainer aria-label="DimensionalDashboardContainer example">
      DimensionalDashboardContainer content
    </DimensionalDashboardContainer>
  );
}
```
