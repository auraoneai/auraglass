...
- Category: form
- Direct Storybook story: `src/components/input/GlassSelectCompound.stories.tsx`
...
```tsx
import { GlassSelectCompound } from 'aura-glass';

export function GlassSelectCompoundExample() {
  return (
    <GlassSelectCompound aria-label="GlassSelectCompound example">
