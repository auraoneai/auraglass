...
```tsx
import { GlassStepLabel } from 'aura-glass';

export function GlassStepLabelExample() {
  return (
    <GlassStepLabel aria-label="GlassStepLabel example">
      GlassStepLabel content
    </GlassStepLabel>
  );
}
```
