...
```tsx
import { GlassCheckboxGroup } from 'aura-glass';

export function GlassCheckboxGroupExample() {
  return (
    <GlassCheckboxGroup aria-label="GlassCheckboxGroup example">
      GlassCheckboxGroup content
    </GlassCheckboxGroup>
  );
}
```
