...
- `src/components/card/GlowingCard.tsx`
...
export function GlowingCardExample() {
  return (
    <GlowingCard aria-label="GlowingCard example">
      GlowingCard content
    </GlowingCard>
  );
}
