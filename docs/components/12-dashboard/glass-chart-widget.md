...
```tsx
import { GlassChartWidget } from 'aura-glass';

export function GlassChartWidgetExample() {
  return (
    <GlassChartWidget aria-label="GlassChartWidget example">
      GlassChartWidget content
    </GlassChartWidget>
  );
}
```
