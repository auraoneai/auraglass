...
export function AccessibilityProviderExample() {
  return (
    <AccessibilityProvider aria-label="AccessibilityProvider example">
      AccessibilityProvider content
    </AccessibilityProvider>
  );
}
```
