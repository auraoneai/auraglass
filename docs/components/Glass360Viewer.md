...
```tsx
import { Glass360Viewer } from 'aura-glass';

export function Glass360ViewerExample() {
  return (
    <Glass360Viewer aria-label="Glass360Viewer example">
      Glass360Viewer content
    </Glass360Viewer>
  );
}
```
