...
```tsx
import { AdvancedAnimations } from 'aura-glass';

export function AdvancedAnimationsExample() {
  return (
    <AdvancedAnimations aria-label="AdvancedAnimations example">
      AdvancedAnimations content
    </AdvancedAnimations>
  );
}
```
