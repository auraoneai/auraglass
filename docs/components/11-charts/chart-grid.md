...
```tsx
import { ChartGrid } from 'aura-glass';

export function ChartGridExample() {
  return (
    <ChartGrid aria-label="ChartGrid example">
      ChartGrid content
    </ChartGrid>
  );
}
