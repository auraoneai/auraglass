...
```tsx
import { ChartTooltip } from 'aura-glass';

export function ChartTooltipExample() {
  return (
    <ChartTooltip aria-label="ChartTooltip example">
