...
```tsx
import { ChartLegend } from 'aura-glass';

export function ChartLegendExample() {
  return (
    <ChartLegend aria-label="ChartLegend example">
      ChartLegend content
    </ChartLegend>
  );
}
