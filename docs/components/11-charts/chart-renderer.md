...
```tsx
import { ChartRenderer } from 'aura-glass';

export function ChartRendererExample() {
  return (
    <ChartRenderer aria-label="ChartRenderer example">
