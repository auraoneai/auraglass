...
```tsx
import { AtmosphericEffects } from 'aura-glass';

export function AtmosphericEffectsExample() {
  return (
    <AtmosphericEffects aria-label="AtmosphericEffects example">
      AtmosphericEffects content
    </AtmosphericEffects>
  );
}
```
