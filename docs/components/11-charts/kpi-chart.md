...
```tsx
import { KpiChart } from 'aura-glass';

export function KpiChartExample() {
  return (
    <KpiChart aria-label="KpiChart example">
      KpiChart content
    </KpiChart>
  );
}
