...
```tsx
import { ChartFilters } from 'aura-glass';

export function ChartFiltersExample() {
  return (
    <ChartFilters aria-label="ChartFilters example">
      ChartFilters content
    </ChartFilters>
  );
}
```
