...
```tsx
import { ChartAxis } from 'aura-glass';

export function ChartAxisExample() {
  return (
    <ChartAxis aria-label="ChartAxis example">
      ChartAxis content
    </ChartAxis>
  );
}
