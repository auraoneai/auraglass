...
- Category: layout
- Direct Storybook story: `src/components/layouts/GlassIslandLayout.stories.tsx`
...
```tsx
import { GlassIslandLayout } from 'aura-glass';

export function GlassIslandLayoutExample() {
  return (
    <GlassIslandLayout aria-label="GlassIslandLayout example">
      GlassIslandLayout content
    </GlassIslandLayout>
  );
}
```
