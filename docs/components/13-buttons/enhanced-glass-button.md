...
export function EnhancedGlassButtonExample() {
  return (
    <EnhancedGlassButton aria-label="EnhancedGlassButton example">
      EnhancedGlassButton content
    </EnhancedGlassButton>
  );
}
```
