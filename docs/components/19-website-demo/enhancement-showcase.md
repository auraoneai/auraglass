...
```tsx
import { EnhancementShowcase } from 'aura-glass';

export function EnhancementShowcaseExample() {
  return (
    <EnhancementShowcase aria-label="EnhancementShowcase example">
      EnhancementShowcase content
    </EnhancementShowcase>
  );
}
```
