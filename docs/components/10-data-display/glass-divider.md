...
```tsx
import { GlassDivider } from 'aura-glass';

export function GlassDividerExample() {
  return (
    <GlassDivider aria-label="GlassDivider example">
      GlassDivider content
    </GlassDivider>
  );
}
```
