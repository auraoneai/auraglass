...
```tsx
import { GlassMetricsGrid } from 'aura-glass';

export function GlassMetricsGridExample() {
  return (
    <GlassMetricsGrid aria-label="GlassMetricsGrid example">
      GlassMetricsGrid content
    </GlassMetricsGrid>
  );
}
```
