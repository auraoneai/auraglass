...
```tsx
import { GlassAvatar } from 'aura-glass';

export function GlassAvatarExample() {
  return (
    <GlassAvatar aria-label="GlassAvatar example">
      GlassAvatar content
    </GlassAvatar>
  );
}
