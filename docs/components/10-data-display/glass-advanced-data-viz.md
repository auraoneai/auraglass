...
export function GlassAdvancedDataVizExample() {
  return (
    <GlassAdvancedDataViz aria-label="GlassAdvancedDataViz example">
      GlassAdvancedDataViz content
    </GlassAdvancedDataViz>
  );
}
```
