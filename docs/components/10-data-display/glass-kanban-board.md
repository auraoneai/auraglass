...
export function GlassKanbanBoardExample() {
  return (
    <GlassKanbanBoard aria-label="GlassKanbanBoard example">
      GlassKanbanBoard content
    </GlassKanbanBoard>
  );
}
```
