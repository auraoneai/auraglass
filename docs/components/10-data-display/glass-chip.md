...
```tsx
import { GlassChip } from 'aura-glass';

export function GlassChipExample() {
  return (
    <GlassChip aria-label="GlassChip example">
      GlassChip content
    </GlassChip>
  );
}
