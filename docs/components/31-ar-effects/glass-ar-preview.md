...
```tsx
import { GlassARPreview } from 'aura-glass';

export function GlassARPreviewExample() {
  return (
    <GlassARPreview aria-label="GlassARPreview example">
      GlassARPreview content
    </GlassARPreview>
  );
}
```
