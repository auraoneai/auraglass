...
```tsx
import { GlassHologram } from 'aura-glass';

export function GlassHologramExample() {
  return (
    <GlassHologram aria-label="GlassHologram example">
      GlassHologram content
    </GlassHologram>
  );
}
```
