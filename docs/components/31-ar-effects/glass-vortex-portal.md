...
- Category: misc
- Direct Storybook story: `src/components/immersive/GlassVortexPortal.stories.tsx`
...
```tsx
import { GlassVortexPortal } from 'aura-glass';

export function GlassVortexPortalExample() {
  return (
    <GlassVortexPortal aria-label="GlassVortexPortal example">
      GlassVortexPortal content
    </GlassVortexPortal>
  );
}
```
