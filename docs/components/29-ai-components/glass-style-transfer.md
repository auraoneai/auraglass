...
```tsx
import { GlassStyleTransfer } from 'aura-glass';

export function GlassStyleTransferExample() {
  return (
    <GlassStyleTransfer aria-label="GlassStyleTransfer example">
      GlassStyleTransfer content
    </GlassStyleTransfer>
  );
}
```
