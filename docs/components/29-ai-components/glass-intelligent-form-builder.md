...
export function GlassIntelligentFormBuilderExample() {
  return (
    <GlassIntelligentFormBuilder aria-label="GlassIntelligentFormBuilder example">
      GlassIntelligentFormBuilder content
    </GlassIntelligentFormBuilder>
  );
}
```
