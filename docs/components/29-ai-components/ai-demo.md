...
- `src/components/ai/examples/AIDemo.tsx`
...
```tsx
import { AIDemo } from 'aura-glass';

export function AIDemoExample() {
  return (
    <AIDemo aria-label="AIDemo example">
      AIDemo content
    </AIDemo>
  );
}
