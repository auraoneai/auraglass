...
```tsx
import { GlassLiveFilter } from 'aura-glass';

export function GlassLiveFilterExample() {
  return (
    <GlassLiveFilter aria-label="GlassLiveFilter example">
      GlassLiveFilter content
    </GlassLiveFilter>
  );
}
```
