...
```tsx
import { GlassGenerativeArt } from 'aura-glass';

export function GlassGenerativeArtExample() {
  return (
    <GlassGenerativeArt aria-label="GlassGenerativeArt example">
      GlassGenerativeArt content
    </GlassGenerativeArt>
  );
}
```
