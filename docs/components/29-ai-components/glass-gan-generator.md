...
```tsx
import { GlassGANGenerator } from 'aura-glass';

export function GlassGANGeneratorExample() {
  return (
    <GlassGANGenerator aria-label="GlassGANGenerator example">
      GlassGANGenerator content
    </GlassGANGenerator>
  );
}
```
