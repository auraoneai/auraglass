...
```tsx
import { GlassProbabilityCloud } from 'aura-glass';

export function GlassProbabilityCloudExample() {
  return (
    <GlassProbabilityCloud aria-label="GlassProbabilityCloud example">
      GlassProbabilityCloud content
    </GlassProbabilityCloud>
  );
}
```
