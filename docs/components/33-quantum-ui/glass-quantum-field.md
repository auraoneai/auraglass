...
export function GlassQuantumFieldExample() {
  return (
    <GlassQuantumField aria-label="GlassQuantumField example">
      GlassQuantumField content
    </GlassQuantumField>
  );
}
```
