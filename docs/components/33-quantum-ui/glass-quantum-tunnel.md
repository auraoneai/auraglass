...
```tsx
import { GlassQuantumTunnel } from 'aura-glass';

export function GlassQuantumTunnelExample() {
  return (
    <GlassQuantumTunnel aria-label="GlassQuantumTunnel example">
      GlassQuantumTunnel content
    </GlassQuantumTunnel>
  );
}
```
