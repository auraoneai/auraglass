...
```tsx
import { GlassWaveFunction } from 'aura-glass';

export function GlassWaveFunctionExample() {
  return (
    <GlassWaveFunction aria-label="GlassWaveFunction example">
      GlassWaveFunction content
    </GlassWaveFunction>
  );
}
```
