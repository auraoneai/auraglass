...
- Category: misc
- Direct Storybook story: `src/components/quantum/GlassCoherenceIndicator.stories.tsx`
...
```tsx
import { GlassCoherenceIndicator } from 'aura-glass';

export function GlassCoherenceIndicatorExample() {
  return (
    <GlassCoherenceIndicator aria-label="GlassCoherenceIndicator example">
      GlassCoherenceIndicator content
    </GlassCoherenceIndicator>
  );
}
```
