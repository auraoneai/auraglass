...
```tsx
import { GlassPresets } from 'aura-glass';

export function GlassPresetsExample() {
  return (
    <GlassPresets aria-label="GlassPresets example">
      GlassPresets content
    </GlassPresets>
  );
}
```
