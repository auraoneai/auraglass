...
```tsx
import { GlassSpotlightSearch } from 'aura-glass';

export function GlassSpotlightSearchExample() {
  return (
    <GlassSpotlightSearch aria-label="GlassSpotlightSearch example">
      GlassSpotlightSearch content
    </GlassSpotlightSearch>
  );
}
```
