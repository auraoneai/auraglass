...
```tsx
import { GlassDrawingCanvas } from 'aura-glass';

export function GlassDrawingCanvasExample() {
  return (
    <GlassDrawingCanvas aria-label="GlassDrawingCanvas example">
      GlassDrawingCanvas content
    </GlassDrawingCanvas>
  );
}
```
