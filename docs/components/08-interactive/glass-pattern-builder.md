...
- Category: misc
- Direct Storybook story: `src/components/interactive/GlassPatternBuilder.stories.tsx`
...
```tsx
import { GlassPatternBuilder } from 'aura-glass';

export function GlassPatternBuilderExample() {
  return (
    <GlassPatternBuilder aria-label="GlassPatternBuilder example">
      GlassPatternBuilder content
    </GlassPatternBuilder>
  );
}
```
