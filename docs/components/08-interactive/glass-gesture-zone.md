...
```tsx
import { GlassGestureZone } from 'aura-glass';

export function GlassGestureZoneExample() {
  return (
    <GlassGestureZone aria-label="GlassGestureZone example">
      GlassGestureZone content
    </GlassGestureZone>
  );
}
```
