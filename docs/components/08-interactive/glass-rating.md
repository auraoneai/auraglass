...
- Category: form
- Direct Storybook story: `src/components/rating/GlassRating.stories.tsx`
...
- `src/components/rating/GlassRating.tsx`
...
```tsx
import { GlassRating } from 'aura-glass';

export function GlassRatingExample() {
  return (
    <GlassRating aria-label="GlassRating example">
      GlassRating content
    </GlassRating>
  );
}
