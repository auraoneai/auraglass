...
- Category: misc
- Direct Storybook story: `src/components/interactive/GlassVoiceInput.stories.tsx`
...
```tsx
import { GlassVoiceInput } from 'aura-glass';

export function GlassVoiceInputExample() {
  return (
    <GlassVoiceInput aria-label="GlassVoiceInput example">
      GlassVoiceInput content
    </GlassVoiceInput>
  );
}
```
