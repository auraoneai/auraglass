...
```tsx
import { GlassSpotlight } from 'aura-glass';

export function GlassSpotlightExample() {
  return (
    <GlassSpotlight aria-label="GlassSpotlight example">
      GlassSpotlight content
    </GlassSpotlight>
  );
}
```
