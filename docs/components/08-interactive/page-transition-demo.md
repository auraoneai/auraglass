...
```tsx
import { PageTransitionDemo } from 'aura-glass';

export function PageTransitionDemoExample() {
  return (
    <PageTransitionDemo aria-label="PageTransitionDemo example">
      PageTransitionDemo content
    </PageTransitionDemo>
  );
}
```
