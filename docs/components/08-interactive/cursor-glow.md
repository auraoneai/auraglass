...
```tsx
import { CursorGlow } from 'aura-glass';

export function CursorGlowExample() {
  return (
    <CursorGlow aria-label="CursorGlow example">
      CursorGlow content
    </CursorGlow>
  );
}
