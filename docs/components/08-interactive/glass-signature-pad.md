...
```tsx
import { GlassSignaturePad } from 'aura-glass';

export function GlassSignaturePadExample() {
  return (
    <GlassSignaturePad aria-label="GlassSignaturePad example">
      GlassSignaturePad content
    </GlassSignaturePad>
  );
}
```
