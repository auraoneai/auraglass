...
export function GlassIntelligentSearchExample() {
  return (
    <GlassIntelligentSearch aria-label="GlassIntelligentSearch example">
      GlassIntelligentSearch content
    </GlassIntelligentSearch>
  );
}
```
